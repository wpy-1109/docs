...
description: "Alibaba Cloud Object Storage Service (OSS), its features, and common use cases."
icon: "cloud"
"og:title": "What is OSS? - Alibaba Cloud OSS"
"og:description": "Alibaba Cloud Object Storage Service (OSS), its features, and common use cases."
---
...
```
Your Application  →  OSS Endpoint  →  Bucket  →  Object 1
                                             →  Object 2
                                             →  Object N
```
...
<CardGroup cols={2}>
  <Card title="OSS console" icon="browser" href="/quickstart">
    Web-based GUI for managing buckets and objects. No installation required.
  </Card>
  <Card title="ossutil CLI" icon="terminal" href="/quickstart">
    Command-line tool for batch operations, scripting, and automation.
  </Card>
  <Card title="SDKs" icon="code" href="/quickstart">
...
<CardGroup cols={2}>
  <Card title="Quickstart: console" icon="rocket" href="/quickstart">
