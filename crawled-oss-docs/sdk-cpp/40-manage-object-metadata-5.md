...
Source: https://help.aliyun.com/zh/oss/developer-reference/manage-object-metadata-5

---

- 使用C++ SDK设置及获取文件元数据-对象存储-阿里云
...
int main(void)
{
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于设置以及获取文件元数据的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/16a995a66b14f236e7fed9787e2dc0bb463d6e47/sample/src/object/ObjectSample.cc#L206)。
...
[上一篇：判断文件是否存在（C++ SDK）](/zh/oss/developer-reference/determine-whether-an-object-exists-5)[下一篇：转换文件存储类型（C++ SDK）](/zh/oss/developer-reference/convert-the-storage-classes-of-objects-1)该文章对您有帮助吗？反馈
