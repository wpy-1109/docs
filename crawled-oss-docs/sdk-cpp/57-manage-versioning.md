# 使用C++ SDK设置Bucket版本控制与列举Object版本

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-versioning

---

- 使用C++ SDK设置Bucket版本控制与列举Object版本-对象存储-阿里云
...
[上一篇：版本控制（C++ SDK）](/zh/oss/developer-reference/versioning-2/)[下一篇：上传文件（C++ SDK）](/zh/oss/developer-reference/upload-an-object-1)该文章对您有帮助吗？反馈
