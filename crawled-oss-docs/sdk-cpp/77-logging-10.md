# 使用C++ SDK管理Bucket的日志转存功能

Source: https://help.aliyun.com/zh/oss/developer-reference/logging-10

---

- 使用C++ SDK管理Bucket的日志转存功能-对象存储-阿里云
...
int main(void)
{
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于日志转存的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/sample/src/bucket/BucketSample.cc)。
...
[上一篇：静态网站托管（C++ SDK）](/zh/oss/developer-reference/static-website-hosting-9)[下一篇：图片处理（C++ SDK）](/zh/oss/developer-reference/image-processing)该文章对您有帮助吗？反馈
