...
Source: https://help.aliyun.com/zh/oss/developer-reference/simple-upload-7

---

- 使用C++ SDK从内存或本地上传文件-对象存储-阿里云
...
int main(void)
{
    ...
    std::shared_ptr content = std::make_shared("D:\\localpath\\examplefile.txt", std::ios::in | std::ios::binary);
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于简单上传的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/16a995a66b14f236e7fed9787e2dc0bb463d6e47/sample/src/object/ObjectSample.cc)。
- 关于简单上传的API接口说明，请参见[PutObject](https://help.aliyun.com/zh/oss/developer-reference/putobject#reference-l5p-ftw-tdb)。

[上一篇：上传文件概述（C++ SDK）](/zh/oss/developer-reference/overview-67)[下一篇：追加上传（C++ SDK）](/zh/oss/developer-reference/append-upload-9)该文章对您有帮助吗？反馈
