...
Source: https://help.aliyun.com/zh/oss/developer-reference/configure-object-tagging-4

---

- 使用C++SDK设置和管理对象标签-对象存储-阿里云
...
说明 
关于对象标签的更多信息，请参见[对象标签](https://help.aliyun.com/zh/oss/user-guide/object-tagging-8#concept-zxf-jpy-pgb)。
...
int main(void)
{
    ...
    /* 追加文件，默认追加position为0。*/
    std::shared_ptr content1 = std::make_shared();
    *content1 
### 断点续传上传时添加对象标签
...
int main(void)
{
    ...
    *content 
## 相关文档
- 关于设置对象标签的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/test/src/Object/ObjectTaggingTest.cc)。
- 关于设置对象标签的API接口说明，请参见[PutObjectTagging](https://help.aliyun.com/zh/oss/developer-reference/putobjecttagging#reference-185784)。

[上一篇：对象标签（C++ SDK）](/zh/oss/developer-reference/object-tagging-3/)[下一篇：获取对象标签（C++ SDK）](/zh/oss/developer-reference/query-the-tags-of-an-object-2)该文章对您有帮助吗？反馈
