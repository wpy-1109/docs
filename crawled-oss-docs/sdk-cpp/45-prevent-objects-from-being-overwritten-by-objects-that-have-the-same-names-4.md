# 使用C++SDK禁止上传或拷贝时覆盖同名文件

Source: https://help.aliyun.com/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-that-have-the-same-names-4

---

- 使用C++SDK禁止上传或拷贝时覆盖同名文件-对象存储-阿里云
...
[上一篇：拷贝文件（C++ SDK）](/zh/oss/developer-reference/copy-objects-10)[下一篇：解冻文件（C++ SDK）](/zh/oss/developer-reference/restore-objects-8)该文章对您有帮助吗？反馈
