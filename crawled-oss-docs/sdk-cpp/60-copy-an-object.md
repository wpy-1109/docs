...
Source: https://help.aliyun.com/zh/oss/developer-reference/copy-an-object

---

- 通过C++ SDK拷贝文件的指定版本-对象存储-阿里云
...
[上一篇：下载文件（C++ SDK）](/zh/oss/developer-reference/download-objects-4)[下一篇：删除文件（C++ SDK）](/zh/oss/developer-reference/delete-objects-3)该文章对您有帮助吗？反馈
