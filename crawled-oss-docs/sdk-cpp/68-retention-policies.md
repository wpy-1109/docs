# 使用C++ SDK新建锁定和管理Bucket保留策略

Source: https://help.aliyun.com/zh/oss/developer-reference/retention-policies

---

- 使用C++ SDK新建锁定和管理Bucket保留策略-对象存储-阿里云
...
[上一篇：跨域资源共享（C++ SDK）](/zh/oss/developer-reference/cors-10)[下一篇：数据加密（C++ SDK）](/zh/oss/developer-reference/data-encryption-5/)该文章对您有帮助吗？反馈
