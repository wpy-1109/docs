# 使用C++ SDK配置基于Referer的防盗链规则

Source: https://help.aliyun.com/zh/oss/developer-reference/cpp-hotlink-protection-12

---

- 使用C++ SDK配置基于Referer的防盗链规则-对象存储-阿里云
...
int main(void)
{
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于防盗链的完整示例代码，请参见[GitHub](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/sample/src/bucket/BucketSample.cc?spm=a2c4g.11186623.0.0.13723e061yNWI4&file=BucketSample.cc)。
...
[上一篇：管理软链接（C++ SDK）](/zh/oss/developer-reference/manage-symbolic-links-3)[下一篇：跨域资源共享（C++ SDK）](/zh/oss/developer-reference/cors-10)该文章对您有帮助吗？反馈
