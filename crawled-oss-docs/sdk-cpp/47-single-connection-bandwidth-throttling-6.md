# 使用C++ SDK在上传下载文件时设置单链接限速

Source: https://help.aliyun.com/zh/oss/developer-reference/single-connection-bandwidth-throttling-6

---

- 使用C++ SDK在上传下载文件时设置单链接限速-对象存储-阿里云
...
[上一篇：解冻文件（C++ SDK）](/zh/oss/developer-reference/restore-objects-8)[下一篇：对象标签（C++ SDK）](/zh/oss/developer-reference/object-tagging-3/)该文章对您有帮助吗？反馈
