# 使用C++ SDK向开启版本控制的存储空间上传文件

Source: https://help.aliyun.com/zh/oss/developer-reference/upload-an-object-1

---

- 使用C++ SDK向开启版本控制的存储空间上传文件-对象存储-阿里云
...
[上一篇：管理版本控制（C++ SDK）](/zh/oss/developer-reference/manage-versioning)[下一篇：下载文件（C++ SDK）](/zh/oss/developer-reference/download-objects-4)该文章对您有帮助吗？反馈
