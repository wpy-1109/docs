# 使用C++ SDK判断存储空间Bucket是否存在

Source: https://help.aliyun.com/zh/oss/developer-reference/determine-whether-a-bucket-exists-cpp

---

- 使用C++ SDK判断存储空间Bucket是否存在-对象存储-阿里云
...
[上一篇：列举存储空间（C++ SDK）](/zh/oss/developer-reference/list-buckets-3)[下一篇：获取存储空间的地域（C++ SDK）](/zh/oss/developer-reference/query-the-region-of-a-bucket-1)该文章对您有帮助吗？反馈
