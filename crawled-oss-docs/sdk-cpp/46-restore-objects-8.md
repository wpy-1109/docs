# 使用C++ SDK解冻归档与冷归档类型Object

Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-8

---

- 使用C++ SDK解冻归档与冷归档类型Object-对象存储-阿里云
...
int main(void)
{
    ...
    //auto content = std::make_shared("test");
    ...
    request.setDays(2);
    /*设置解冻冷归档类型文件的优先级。TierType::Bulk表示5~12个小时之内解冻完成。*/
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于解冻归档和冷归档类型Object的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/16a995a66b14f236e7fed9787e2dc0bb463d6e47/sample/src/object/ObjectSample.cc)。
- 关于解冻Object的API接口说明，请参见[RestoreObject](https://help.aliyun.com/zh/oss/developer-reference/restoreobject#reference-mfr-5bx-wdb)。

[上一篇：禁止覆盖同名文件（C++ SDK）](/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-that-have-the-same-names-4)[下一篇：单链接限速（C++ SDK）](/zh/oss/developer-reference/single-connection-bandwidth-throttling-6)该文章对您有帮助吗？反馈
