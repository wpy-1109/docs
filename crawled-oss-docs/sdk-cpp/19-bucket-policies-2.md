# 使用C++ SDK管理Bucket Policy

Source: https://help.aliyun.com/zh/oss/developer-reference/bucket-policies-2

---

- 使用C++ SDK管理Bucket Policy-对象存储-阿里云
...
[上一篇：管理文件访问权限（C++ SDK）](/zh/oss/developer-reference/manage-object-acls-9)[下一篇：对象/文件（C++ SDK）](/zh/oss/developer-reference/objects-4/)该文章对您有帮助吗？反馈
