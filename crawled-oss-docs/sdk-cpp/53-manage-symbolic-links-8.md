...
Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-8

---

- 通过C++ SDK创建和获取软链接-对象存储-阿里云
...
[上一篇：对象标签和生命周期管理（C++ SDK）](/zh/oss/developer-reference/object-tagging-and-lifecycle-management-1)[下一篇：管理目录（C++ SDK）](/zh/oss/developer-reference/c-management-directory)该文章对您有帮助吗？反馈
