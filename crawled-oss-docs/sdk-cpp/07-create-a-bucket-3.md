...
Source: https://help.aliyun.com/zh/oss/developer-reference/create-a-bucket-3

---

- 调用C++ SDK创建存储空间-对象存储-阿里云
...
int main(void)
{
    ...
    if (!outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于创建存储空间的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/sample/src/bucket/BucketSample.cc?spm=a2c4g.11186623.0.0.13727873rwnqwv&file=BucketSample.cc)。
- 关于创建存储空间的API接口说明，请参见[PutBucket](https://help.aliyun.com/zh/oss/developer-reference/putbucket#doc-api-Oss-PutBucket)。

[上一篇：存储空间（C++ SDK）](/zh/oss/developer-reference/buckets-5/)[下一篇：列举存储空间（C++ SDK）](/zh/oss/developer-reference/list-buckets-3)该文章对您有帮助吗？反馈
