...
Source: https://help.aliyun.com/zh/oss/developer-reference/c-management-directory

---

- 使用C++ SDK创建和删除目录-对象存储-阿里云
...
以下代码用于删除exampledir目录及该目录下的所有文件。
...
int main(void)
{
    ...
    do {
            ...
            if (!outcome.isSuccess()) {
                /* 异常处理。*/
                std::cout - 关于创建目录的API接口说明，请参见[PutObject](https://help.aliyun.com/zh/oss/developer-reference/putobject)。
- 关于删除目录的API接口说明，请参见[DeleteObject](https://help.aliyun.com/zh/oss/developer-reference/deleteobject)。

[上一篇：管理软链接（C++ SDK）](/zh/oss/developer-reference/manage-symbolic-links-8)[下一篇：数据安全（C++ SDK）](/zh/oss/developer-reference/data-security-5/)该文章对您有帮助吗？反馈
