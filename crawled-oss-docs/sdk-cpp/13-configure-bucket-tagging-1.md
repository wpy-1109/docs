...
Source: https://help.aliyun.com/zh/oss/developer-reference/configure-bucket-tagging-1

---

- C++SDK管理存储空间标签代码示例-对象存储-阿里云
...
- 只有Bucket拥有者及授予`oss:PutBucketTagging`权限的用户才能为Bucket设置标签，否则返回403 Forbidden错误，错误码为AccessDenied。
...
- 关于获取Bucket标签信息的API接口说明，请参见[GetBucketTags](https://help.aliyun.com/zh/oss/developer-reference/getbuckettags#concept-261796)。
...
[上一篇：删除存储空间（C++ SDK）](/zh/oss/developer-reference/delete-a-bucket-3)[下一篇：请求者付费模式（C++ SDK）](/zh/oss/developer-reference/pay-by-requester-2)该文章对您有帮助吗？反馈
