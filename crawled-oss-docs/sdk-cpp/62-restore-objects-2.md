...
Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-2
...
[上一篇：删除文件（C++ SDK）](/zh/oss/developer-reference/delete-objects-3)[下一篇：获取文件元数据（C++ SDK）](/zh/oss/developer-reference/query-object-metadata-1)该文章对您有帮助吗？反馈
