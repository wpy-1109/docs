...
Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-3

---

- C++ SDK创建和获取软链接-对象存储-阿里云
...
[上一篇：管理文件访问权限（C++ SDK）](/zh/oss/developer-reference/manage-object-acls-14)[下一篇：防盗链（C++ SDK）](/zh/oss/developer-reference/cpp-hotlink-protection-12)该文章对您有帮助吗？反馈
