# 使用C++ SDK基于对象标签设置和查看生命周期规则

Source: https://help.aliyun.com/zh/oss/developer-reference/object-tagging-and-lifecycle-management-1

---

- 使用C++ SDK基于对象标签设置和查看生命周期规则-对象存储-阿里云
...
int main(void)
{
   ...
   /* yourEndpoint填写Bucket所在地域对应的Endpoint。以华东1（杭州）为例，Endpoint填写为https://oss-cn-hangzhou.aliyuncs.com。*/
    ...
    if (outcome.isSuccess()) {
        std::cout 
## 相关文档
- 关于生命周期规则的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/test/src/Object/ObjectTaggingTest.cc?spm=a2c4g.11186623.0.0.13724c9e04bbLh&file=ObjectTaggingTest.cc)。
...
[上一篇：删除对象标签（C++ SDK）](/zh/oss/developer-reference/delete-object-tags-2)[下一篇：管理软链接（C++ SDK）](/zh/oss/developer-reference/manage-symbolic-links-8)该文章对您有帮助吗？反馈
