# 使用C++ SDK调用AppendObject追加上传文件

Source: https://help.aliyun.com/zh/oss/developer-reference/append-upload-9

---

- 使用C++ SDK调用AppendObject追加上传文件-对象存储-阿里云
...
int main(void)
{
    ...
    *content1  content2 = std::make_shared();
    *content2 
## 相关文档
- 关于追加上传的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/16a995a66b14f236e7fed9787e2dc0bb463d6e47/sample/src/object/ObjectSample.cc)。
- 关于追加上传的API接口说明，请参见[AppendObject](https://help.aliyun.com/zh/oss/developer-reference/appendobject#reference-fvf-xld-5db)。

[上一篇：简单上传（C++ SDK）](/zh/oss/developer-reference/simple-upload-7)[下一篇：断点续传上传（C++ SDK）](/zh/oss/developer-reference/resumable-upload-2)该文章对您有帮助吗？反馈
