...
Source: https://help.aliyun.com/zh/oss/developer-reference/list-buckets-3

---

- 使用C++SDK列举账号下所有存储空间-对象存储-阿里云
...
int main(void)
{
    ...
    if (outcome.isSuccess()) {
        ...
        std::cout 
## 相关文档
- 关于列举存储空间的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-cpp-sdk/blob/master/sample/src/bucket/BucketSample.cc)。
...
[上一篇：创建存储空间（C++ SDK）](/zh/oss/developer-reference/create-a-bucket-3)[下一篇：判断存储空间是否存在（C++ SDK）](/zh/oss/developer-reference/determine-whether-a-bucket-exists-cpp)该文章对您有帮助吗？反馈
