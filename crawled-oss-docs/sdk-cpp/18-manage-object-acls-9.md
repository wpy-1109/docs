...
Source: https://help.aliyun.com/zh/oss/developer-reference/manage-object-acls-9

---

- 文件访问权限类型详解与管理方法-对象存储-阿里云
...
[上一篇：管理存储空间读写权限（C++ SDK）](/zh/oss/developer-reference/manage-bucket-acls-2)[下一篇：Bucket Policy（C++ SDK）](/zh/oss/developer-reference/bucket-policies-2)该文章对您有帮助吗？反馈
