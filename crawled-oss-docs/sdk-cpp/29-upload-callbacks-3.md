...
Source: https://help.aliyun.com/zh/oss/developer-reference/upload-callbacks-3

---

- 使用C++ SDK在上传文件时设置回调-对象存储-阿里云
...
[上一篇：上传进度条（C++ SDK）](/zh/oss/developer-reference/progress-bar-5)[下一篇：下载文件（C++ SDK）](/zh/oss/developer-reference/download-objects-12/)该文章对您有帮助吗？反馈
