# 使用C++ SDK通过versionId下载指定版本文件

Source: https://help.aliyun.com/zh/oss/developer-reference/download-objects-4

---

- 使用C++ SDK通过versionId下载指定版本文件-对象存储-阿里云
...
[上一篇：上传文件（C++ SDK）](/zh/oss/developer-reference/upload-an-object-1)[下一篇：拷贝文件（C++ SDK）](/zh/oss/developer-reference/copy-an-object)该文章对您有帮助吗？反馈
