...
Source: https://help.aliyun.com/zh/oss/developer-reference/logging-6

---

- Ruby SDK管理访问日志转存-对象存储-阿里云
...
[上一篇：防盗链（Ruby SDK）](/zh/oss/developer-reference/ruby-hotlink-protection)[下一篇：跨域资源共享（Ruby SDK）](/zh/oss/developer-reference/cors-6)该文章对您有帮助吗？反馈
