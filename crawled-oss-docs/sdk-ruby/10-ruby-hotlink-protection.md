# 使用Ruby SDK设置Referer防盗链规则

Source: https://help.aliyun.com/zh/oss/developer-reference/ruby-hotlink-protection

---

- 使用Ruby SDK设置Referer防盗链规则-对象存储-阿里云
...
- 本文以OSS域名新建OSSClient为例。如果您希望通过自定义域名、STS等方式新建OSSClient，请参见[初始化（Ruby SDK）](https://help.aliyun.com/zh/oss/developer-reference/initialization-11)。
...
[上一篇：生命周期（Ruby SDK）](/zh/oss/developer-reference/manage-lifecycle-rules-1)[下一篇：日志转存（Ruby SDK）](/zh/oss/developer-reference/logging-6)该文章对您有帮助吗？反馈
