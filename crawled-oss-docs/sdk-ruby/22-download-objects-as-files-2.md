# 使用Ruby SDK下载Object到本地文件

Source: https://help.aliyun.com/zh/oss/developer-reference/download-objects-as-files-2

---

- 使用Ruby SDK下载Object到本地文件-对象存储-阿里云
...
[上一篇：下载文件（Ruby SDK）](/zh/oss/developer-reference/download-objects-10/)[下一篇：流式下载（Ruby SDK）](/zh/oss/developer-reference/streaming-download-4)该文章对您有帮助吗？反馈
