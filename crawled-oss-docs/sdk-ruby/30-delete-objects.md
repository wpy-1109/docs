...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-objects

---

- 使用Ruby SDK删除单个及批量文件-对象存储-阿里云
...
警告 - Object删除后无法恢复，请谨慎操作。
- 为避免影响OSS-HDFS服务的正常使用或者引发数据丢失的风险，禁止删除开通了OSS-HDFS服务的Bucket中的数据存储目录`.dlsdata/`下的任意Object。
...
[上一篇：拷贝文件（Ruby SDK）](/zh/oss/developer-reference/copy-objects)[下一篇：授权访问（Ruby SDK）](/zh/oss/developer-reference/authorized-access-2)该文章对您有帮助吗？反馈
