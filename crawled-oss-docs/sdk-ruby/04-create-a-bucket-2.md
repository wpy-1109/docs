# 使用Ruby SDK创建存储空间Bucket

Source: https://help.aliyun.com/zh/oss/developer-reference/create-a-bucket-2

---

- 使用Ruby SDK创建存储空间Bucket-对象存储-阿里云
...
[上一篇：存储空间（Ruby SDK）](/zh/oss/developer-reference/buckets-8/)[下一篇：列举存储空间（Ruby SDK）](/zh/oss/developer-reference/list-buckets-7)该文章对您有帮助吗？反馈
