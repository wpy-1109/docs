# 使用Ruby SDK设置和修改文件元数据

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-object-metadata

---

- 使用Ruby SDK设置和修改文件元数据-对象存储-阿里云
...
## 注意事项
- 在Ruby SDK中，文件元数据用`Hash`来表示，其他key和value均为`String`类型。
...
[上一篇：管理文件访问权限（Ruby SDK）](/zh/oss/developer-reference/manage-object-acls-5)[下一篇：列举文件（Ruby SDK）](/zh/oss/developer-reference/list-objects)该文章对您有帮助吗？反馈
