# 使用Ruby SDK实现OSS文件流式下载

Source: https://help.aliyun.com/zh/oss/developer-reference/streaming-download-4

---

- 使用Ruby SDK实现OSS文件流式下载-对象存储-阿里云
...
[上一篇：下载到本地文件（Ruby SDK）](/zh/oss/developer-reference/download-objects-as-files-2)[下一篇：断点续传下载（Ruby SDK）](/zh/oss/developer-reference/resumable-download-5)该文章对您有帮助吗？反馈
