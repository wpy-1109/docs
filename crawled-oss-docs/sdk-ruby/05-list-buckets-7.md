# 使用Ruby SDK列举全部或指定前缀的存储空间

Source: https://help.aliyun.com/zh/oss/developer-reference/list-buckets-7

---

- 使用Ruby SDK列举全部或指定前缀的存储空间-对象存储-阿里云
...
[上一篇：创建存储空间（Ruby SDK）](/zh/oss/developer-reference/create-a-bucket-2)[下一篇：判断存储空间是否存在（Ruby SDK）](/zh/oss/developer-reference/determine-whether-a-bucket-exists-5)该文章对您有帮助吗？反馈
