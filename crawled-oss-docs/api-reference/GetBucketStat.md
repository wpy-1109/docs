...
A container for the BucketStat structure.
...
The total actual storage capacity of the bucket. Unit: bytes.
...
The number of multipart parts uploaded to the bucket.
...
The storage capacity of the multipart parts uploaded to the bucket. Unit: bytes.
...
The time point of the obtained storage information. The value is a UNIX timestamp in seconds.
...
The number of Standard multipart parts uploaded to the bucket.
...
The storage capacity of the Standard multipart parts uploaded to the bucket. Unit: bytes.
...
An object smaller than 64 KB is calculated as 64 KB. For more information about billing, see Storage fees.
...
The actual amount of storage used by the Infrequent Access storage class, in bytes.
...
The number of IA multipart parts uploaded to the bucket.
...
The storage capacity of the IA multipart parts uploaded to the bucket. Unit: bytes.
...
The billable storage capacity of Archive objects. Unit: bytes.
...
The actual storage capacity of Archive objects. Unit: bytes.
...
The number of Archive multipart parts uploaded to the bucket.
...
The storage capacity of the Archive multipart parts uploaded to the bucket. Unit: bytes.
...
The number of Cold Archive multipart parts uploaded to the bucket.
...
The storage capacity of the Cold Archive multipart parts uploaded to the bucket. Unit: bytes.
...
The billable storage capacity of Deep Cold Archive objects. Unit: bytes.
...
The actual storage capacity of Deep Cold Archive objects. Unit: bytes.
...
The number of Deep Cold Archive multipart parts uploaded to the bucket.
...
The storage capacity of the Deep Cold Archive multipart parts uploaded to the bucket. Unit: bytes.
...
For more information about the ossutil command for the GetBucketStat operation, see get-bucket-stat.
...
You do not have the permission to view the storage capacity information of the bucket. Only the bucket owner can view this information.