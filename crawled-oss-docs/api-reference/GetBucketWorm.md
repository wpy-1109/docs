...
The time when the retention policy is created.
...
For information about the ossutil command that corresponds to the GetBucketWorm operation, see get-bucket-worm.