...
All request headers in a GetCnameToken request are common request headers. For more information, see Common request headers.
...
For information about the ossutil command that corresponds to the GetCnameToken operation, see get-cname-token.
...
The CNAME record that you want to query is not included in the parameter list or the format of the CNAME record is invalid.
