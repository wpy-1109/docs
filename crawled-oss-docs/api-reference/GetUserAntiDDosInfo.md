...
By default, an Alibaba Cloud account has the permissions to query Anti-DDoS instances. To make query requests as a RAM user or using Security Token Service (STS), you must have the oss:GetUserAntiDDosInfo permission. For more information, see Common examples of RAM policies.
