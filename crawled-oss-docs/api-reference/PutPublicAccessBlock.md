...
The container that stores the Block Public Access information.

Parent node: None

Child node: BlockPublicAccess
...
The response to this operation includes only common response headers. For more information, see Common response headers.
...
For information about the ossutil command that corresponds to this operation, see put-public-access-block.