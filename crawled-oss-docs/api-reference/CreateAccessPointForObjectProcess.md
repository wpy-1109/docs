...
Parent nodes: CreateAccessPointForObjectProcessConfiguration
...
The Alibaba Cloud Resource Name (ARN) of the role that Function Compute uses to access your resources in other cloud services. The default role is AliyunFCDefaultRole. For more information, see Quickly create a function.
...
The ARN of the function. For more information, see Obtain the ARN of a function.
...
Child nodes: AccessPointForObjectProcessArn and Alias
