...
Indicates whether Block Public Access is enabled for OSS resources.
...
You can use OSS SDK for Go V2 to call the GetPublicAccessBlock operation.

ossutil

For information about the ossutil command that corresponds to the GetPublicAccessBlock operation, see get-public-access-block.