# 使用Browser.js SDK创建软链接及获取其目标

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-17

---

- 使用Browser.js SDK创建软链接及获取其目标-对象存储-阿里云
...
## 相关文档
- 创建软链接关于创建软链接的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#putsymlinkname-targetname-options)。
- 关于创建软链接的API接口说明，请参见[PutSymlink](https://help.aliyun.com/zh/oss/developer-reference/putsymlink#reference-qzz-qzw-wdb)。
- 获取软链接指向的目标Object关于获取软链接指向的目标Object的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#getsymlinkname-options)。
- 关于获取软链接指向的目标Object的API接口说明，请参见[GetSymlink](https://help.aliyun.com/zh/oss/developer-reference/getsymlink#reference-s3d-s1x-wdb)。

[上一篇：管理文件元数据（Browser.js SDK）](/zh/oss/developer-reference/manage-object-metadata-3)[下一篇：删除文件（Browser.js SDK）](/zh/oss/developer-reference/delete-objects-17)该文章对您有帮助吗？反馈
