# 使用Browser.js SDK创建和删除目录

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-directories-4

---

- 使用Browser.js SDK创建和删除目录-对象存储-阿里云
...
## 相关文档
- 关于创建目录的API接口说明，请参见[PutObject](https://help.aliyun.com/zh/oss/developer-reference/putobject#reference-l5p-ftw-tdb)。
...
[上一篇：删除文件（Browser.js SDK）](/zh/oss/developer-reference/delete-objects-17)[下一篇：使用自定义域名（Browser.js SDK）](/zh/oss/developer-reference/map-custom-domain-names)该文章对您有帮助吗？反馈
