# 使用Browser.js SDK设置下载文件时的单链接限速

Source: https://help.aliyun.com/zh/oss/developer-reference/single-connection-bandwidth-throttling-3

---

- 使用Browser.js SDK设置下载文件时的单链接限速-对象存储-阿里云
...
关于单链接限速的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#signatureurlname-options)。

[上一篇：转换文件存储类型（Browser.js SDK）](/zh/oss/developer-reference/convert-the-storage-classes-of-objects-2)[下一篇：解冻文件（Browser.js SDK）](/zh/oss/developer-reference/restore-objects-13)该文章对您有帮助吗？反馈
