# 使用Browser.js SDK判断Object是否存在

Source: https://help.aliyun.com/zh/oss/developer-reference/determine-whether-an-object-exists-4

---

- 使用Browser.js SDK判断Object是否存在-对象存储-阿里云
...
以下代码用于判断examplebucket中的exampleobject.txt是否存在。
...
[上一篇：管理文件（Browser.js SDK）](/zh/oss/developer-reference/manage-objects-8/)[下一篇：列举文件（Browser.js SDK）](/zh/oss/developer-reference/list-objects-16)该文章对您有帮助吗？反馈
