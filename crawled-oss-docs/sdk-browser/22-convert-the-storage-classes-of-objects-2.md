# 使用Browser.js SDK通过复制Object转换其存储类型

Source: https://help.aliyun.com/zh/oss/developer-reference/convert-the-storage-classes-of-objects-2

---

- 使用Browser.js SDK通过复制Object转换其存储类型-对象存储-阿里云
...
```
    ...
    转换
      ...
      change.addEventListener("click", () => {
        ...
        console.log("开始转换");
        client
          // 指定srcobject.txt拷贝后的文件名称为destobject.txt。
...
## 相关文档
- 关于转换文件存储类型的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#copyname-sourcename-sourcebucket-options)。
- 关于转换文件存储类型的API接口说明，请参见[CopyObject](https://help.aliyun.com/zh/oss/developer-reference/copyobject#reference-mvx-xxc-5db)。

[上一篇：禁止覆盖同名文件（Browser.js SDK）](/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-with-the-same-names)[下一篇：单链接限速（Browser.js SDK）](/zh/oss/developer-reference/single-connection-bandwidth-throttling-3)该文章对您有帮助吗？反馈
