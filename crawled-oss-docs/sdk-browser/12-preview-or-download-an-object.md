# 使用Browser.js SDK生成文件预览和下载的签名URL

Source: https://help.aliyun.com/zh/oss/developer-reference/preview-or-download-an-object

---

- 使用Browser.js SDK生成文件预览和下载的签名URL-对象存储-阿里云
...
说明 
如果您要直接在浏览器中预览文件，请设置文件HTTP头中的Content-Disposition为inline并使用Bucket绑定的自定义域名进行访问。具体操作，请分别参见[设置文件元信息](https://help.aliyun.com/zh/oss/configure-object-metadata#concept-pk1-sxl-vdb)和[使用自定义域名（Browser.js SDK）](https://help.aliyun.com/zh/oss/developer-reference/map-custom-domain-names#concept-64059-zh)。
...
[上一篇：下载文件（Browser.js SDK）](/zh/oss/developer-reference/download-objects-20/)[下一篇：范围下载（Browser.js SDK）](/zh/oss/developer-reference/range-download-3)该文章对您有帮助吗？反馈
