# 配置Browser.js SDK使用自定义域名访问OSS

Source: https://help.aliyun.com/zh/oss/developer-reference/map-custom-domain-names

---

- 配置Browser.js SDK使用自定义域名访问OSS-对象存储-阿里云
...
已绑定自定义域名。具体操作，请参见[通过自定义域名访问OSS](https://help.aliyun.com/zh/oss/user-guide/access-buckets-via-custom-domain-names)。
...
[上一篇：管理目录（Browser.js SDK）](/zh/oss/developer-reference/manage-directories-4)[下一篇：图片处理（Browser.js SDK）](/zh/oss/developer-reference/img)该文章对您有帮助吗？反馈
