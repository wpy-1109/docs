# 使用Browser.js SDK上传文件时触发回调

Source: https://help.aliyun.com/zh/oss/developer-reference/upload-callbacks-10

---

- 使用Browser.js SDK上传文件时触发回调-对象存储-阿里云
...
您只需要在发送给OSS的请求中携带相应的Callback参数，即可在完成文件（Object）上传时提供回调（Callback）给应用服务器。
说明 
...
[上一篇：断点续传上传（Browser.js SDK）](/zh/oss/developer-reference/resumable-upload-9)[下一篇：下载文件（Browser.js SDK）](/zh/oss/developer-reference/download-objects-20/)该文章对您有帮助吗？反馈
