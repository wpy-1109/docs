# 使用Browser.js SDK删除OSS单个或多个文件

Source: https://help.aliyun.com/zh/oss/developer-reference/delete-objects-17

---

- 使用Browser.js SDK删除OSS单个或多个文件-对象存储-阿里云
...
## 相关文档
- 删除单个文件关于删除单个文件的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#deletename-options)。
- 关于删除单个文件的API接口说明，请参见[DeleteObject](https://help.aliyun.com/zh/oss/developer-reference/deleteobject#reference-iqc-mqv-wdb)。
- 删除多个文件关于删除多个文件的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss#deletemultinames-options)
...
[上一篇：管理软链接（Browser.js SDK）](/zh/oss/developer-reference/manage-symbolic-links-17)[下一篇：管理目录（Browser.js SDK）](/zh/oss/developer-reference/manage-directories-4)该文章对您有帮助吗？反馈
