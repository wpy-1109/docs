# 使用Browser.js SDK解冻归档和冷归档类型Object

Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-13

---

- 使用Browser.js SDK解冻归档和冷归档类型Object-对象存储-阿里云
...
## 相关文档
- 关于解冻归档以及冷归档Object的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss/blob/master/README.md#restorename-options)。
- 关于解冻归档以及冷归档Object的API接口说明，请参见[RestoreObject](https://help.aliyun.com/zh/oss/developer-reference/restoreobject#reference-mfr-5bx-wdb)。

[上一篇：单链接限速（Browser.js SDK）](/zh/oss/developer-reference/single-connection-bandwidth-throttling-3)[下一篇：管理文件元数据（Browser.js SDK）](/zh/oss/developer-reference/manage-object-metadata-3)该文章对您有帮助吗？反馈
