# 使用OSSAndroidSDK实现断点续传下载文件

Source: https://help.aliyun.com/zh/oss/developer-reference/resumable-download-6

---

- 使用OSSAndroidSDK实现断点续传下载文件-对象存储-阿里云
...
OSSAsyncTask task = oss.asyncResumableDownload(request, new OSSCompletedCallback() {
    @Override
...
## 相关文档
- 关于断点续传下载的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/ResumableDownloadTest.java)。
...
[上一篇：限定条件下载（Android SDK）](/zh/oss/developer-reference/conditional-download-1)[下一篇：进度条（Android SDK）](/zh/oss/developer-reference/progress-bar-1)该文章对您有帮助吗？反馈
