...
Source: https://help.aliyun.com/zh/oss/developer-reference/create-buckets-5

---

- 使用Android SDK创建存储空间-对象存储-阿里云
...
- 北京时间2025年10月13日10:00:00起，OSS逐步调整所有地域通过API、SDK、ossutil创建Bucket时默认开启阻止公共访问。各个地域的生效变更时间，请参见[公告说明](https://www.aliyun.com/notice/117116)。
...
| `oss:PutBucketAcl` | 创建Bucket后，修改Bucket的ACL，需要此操作的权限。|
...
## 相关文档
- 关于创建Bucket的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/OSSBucketTest.java?spm=a2c4g.11186623.0.0.50797873bfKJZj&file=OSSBucketTest.java)。
- 关于创建Bucket的API接口说明，请参见[PutBucket](https://help.aliyun.com/zh/oss/developer-reference/putbucket#doc-api-Oss-PutBucket)。
...
[上一篇：存储空间（Android SDK）](/zh/oss/developer-reference/buckets-4/)[下一篇：列举存储空间（Android SDK）](/zh/oss/developer-reference/list-buckets-4)该文章对您有帮助吗？反馈
