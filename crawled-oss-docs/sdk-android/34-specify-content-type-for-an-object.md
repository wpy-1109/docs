# 使用Android SDK在上传文件时通过ObjectMetadata设置Content

Source: https://help.aliyun.com/zh/oss/developer-reference/specify-content-type-for-an-object

---

- 使用Android SDK在上传文件时通过ObjectMetadata设置Content-Type-对象存储-阿里云
...
[上一篇：删除文件（Android SDK）](/zh/oss/developer-reference/delete-an-object)[下一篇：获取文件元数据（Android SDK）](/zh/oss/developer-reference/query-object-metadata-5)该文章对您有帮助吗？反馈
