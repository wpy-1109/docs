# 使用Android SDK下载OSS文件到本地

Source: https://help.aliyun.com/zh/oss/developer-reference/download-objects-as-local-files

---

- 使用Android SDK下载OSS文件到本地-对象存储-阿里云
...
// 开始读取数据。
        ...
        if (length > 0) {
            ...
            while (readCount 
## 相关文档
- 关于下载到本地文件的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/OSSGetObjectTest.java)。
- 关于下载到本地文件的API接口说明，请参见[GetObject](https://help.aliyun.com/zh/oss/developer-reference/getobject#reference-ccf-rgd-5db)。
...
[上一篇：下载文件（Android SDK）](/zh/oss/developer-reference/download-objects-1/)[下一篇：流式下载（Android SDK）](/zh/oss/developer-reference/streaming-download)该文章对您有帮助吗？反馈
