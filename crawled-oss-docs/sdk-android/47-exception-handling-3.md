# AndroidSDK异常体系与错误码解析

Source: https://help.aliyun.com/zh/oss/developer-reference/exception-handling-3

---

- AndroidSDK异常体系与错误码解析-对象存储-阿里云
...
有关OSS常见错误码汇总的更多信息，请参见[OSS错误码](https://help.aliyun.com/zh/oss/user-guide/overview-14#concept-dt2-hq3-wdb)。

[上一篇：授权访问（Android SDK）](/zh/oss/developer-reference/authorize-access)[下一篇：常见问题（Android SDK）](/zh/oss/developer-reference/faq-11)该文章对您有帮助吗？反馈
