# 使用Android SDK单个或批量删除文件

Source: https://help.aliyun.com/zh/oss/developer-reference/delete-an-object

---

- 使用Android SDK单个或批量删除文件-对象存储-阿里云
...
oss.asyncDeleteMultipleObject(request, new OSSCompletedCallback() {
    @Override
...
- 删除多个文件关于删除多个文件的API接口说明，请参见[DeleteMultipleObjects](https://help.aliyun.com/zh/oss/developer-reference/deletemultipleobjects#reference-ydg-25v-wdb)。
...
[上一篇：禁止覆盖同名文件（Android SDK）](/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-with-the-same-names-1)[下一篇：设置Content-Type（Android SDK）](/zh/oss/developer-reference/specify-content-type-for-an-object)该文章对您有帮助吗？反馈
