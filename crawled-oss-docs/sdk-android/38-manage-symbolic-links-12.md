# AndroidSDK创建软链接并获取目标文件

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-12

---

- AndroidSDK创建软链接并获取目标文件-对象存储-阿里云
...
// 设置是否禁止覆盖同名Object。此处设置为true，表示禁止覆盖同名Object。
//metadata.setHeader("x-oss-forbid-overwrite", "true");
// 指定Object的访问权限。此处设置为private，表示私有权限。
//metadata.setHeader("x-oss-object-acl", "private");
// 指定Object存储类型。此处设置为Standard，表示标准存储。
...
OSSAsyncTask task = oss.asyncGetSymlink(getSymlink, new OSSCompletedCallback() {
    @Override
...
## 相关文档
- 关于软链接的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/SymlinkTest.java)。
...
[上一篇：解冻文件（Android SDK）](/zh/oss/developer-reference/restore-an-archive-object)[下一篇：数据安全（Android SDK）](/zh/oss/developer-reference/data-security-6/)该文章对您有帮助吗？反馈
