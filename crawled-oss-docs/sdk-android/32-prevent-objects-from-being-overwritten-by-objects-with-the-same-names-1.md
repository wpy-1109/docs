...
Source: https://help.aliyun.com/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-with-the-same-names-1

---

- Android SDK设置x-oss-forbid-overwrite禁止覆盖同名文件-对象存储-阿里云
...
[上一篇：重命名文件（Android SDK）](/zh/oss/developer-reference/rename-an-object-1)[下一篇：删除文件（Android SDK）](/zh/oss/developer-reference/delete-an-object)该文章对您有帮助吗？反馈
