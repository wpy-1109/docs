# 使用Android SDK流式下载OSS文件

Source: https://help.aliyun.com/zh/oss/developer-reference/streaming-download

---

- 使用Android SDK流式下载OSS文件-对象存储-阿里云
...
// 设置下载进度回调。
get.setProgressListener(new OSSProgressCallback() {
            @Override
...
## 相关文档
- 关于流式下载的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/OSSGetObjectTest.java)。
...
[上一篇：下载到本地文件（Android SDK）](/zh/oss/developer-reference/download-objects-as-local-files)[下一篇：范围下载（Android SDK）](/zh/oss/developer-reference/range-download-1)该文章对您有帮助吗？反馈
