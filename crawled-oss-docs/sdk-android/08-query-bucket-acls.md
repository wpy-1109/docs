# 使用Android SDK获取存储空间ACL

Source: https://help.aliyun.com/zh/oss/developer-reference/query-bucket-acls

---

- 使用Android SDK获取存储空间ACL-对象存储-阿里云
...
## 相关文档
- 关于获取存储空间读写权限的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/OSSBucketTest.java)。
...
[上一篇：列举存储空间（Android SDK）](/zh/oss/developer-reference/list-buckets-4)[下一篇：获取存储空间信息（Android SDK）](/zh/oss/developer-reference/query-bucket-information-3)该文章对您有帮助吗？反馈
