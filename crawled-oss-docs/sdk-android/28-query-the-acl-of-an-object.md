# 使用AndroidSDK获取Object访问权限

Source: https://help.aliyun.com/zh/oss/developer-reference/query-the-acl-of-an-object

---

- 使用AndroidSDK获取Object访问权限-对象存储-阿里云
...
// 以下代码用于获取文件的访问权限。
oss.asyncGetObjectACL(request, new OSSCompletedCallback() {
    @Override
...
[上一篇：判断文件是否存在（Android SDK）](/zh/oss/developer-reference/determine-whether-an-object-exists-7)[下一篇：拷贝文件（Android SDK）](/zh/oss/developer-reference/copy-an-object-3)该文章对您有帮助吗？反馈
