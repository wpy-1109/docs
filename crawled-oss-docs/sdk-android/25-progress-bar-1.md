# 使用Android SDK下载文件时显示进度条

Source: https://help.aliyun.com/zh/oss/developer-reference/progress-bar-1

---

- 使用Android SDK下载文件时显示进度条-对象存储-阿里云
...
## 相关文档
- 关于下载文件的进度条使用方法的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/OSSGetObjectTest.java)。
...
[上一篇：断点续传下载（Android SDK）](/zh/oss/developer-reference/resumable-download-6)[下一篇：管理文件（Android SDK）](/zh/oss/developer-reference/manage-objects/)该文章对您有帮助吗？反馈
