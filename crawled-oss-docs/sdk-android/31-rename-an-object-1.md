# 使用Android SDK通过复制删除实现Object重命名

Source: https://help.aliyun.com/zh/oss/developer-reference/rename-an-object-1

---

- 使用Android SDK通过复制删除实现Object重命名-对象存储-阿里云
...
[上一篇：列举文件（Android SDK）](/zh/oss/developer-reference/list-objects-4)[下一篇：禁止覆盖同名文件（Android SDK）](/zh/oss/developer-reference/prevent-objects-from-being-overwritten-by-objects-with-the-same-names-1)该文章对您有帮助吗？反馈
