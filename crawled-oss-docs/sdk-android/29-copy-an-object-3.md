# 使用Android SDK在同地域Bucket间复制文件

Source: https://help.aliyun.com/zh/oss/developer-reference/copy-an-object-3

---

- 使用Android SDK在同地域Bucket间复制文件-对象存储-阿里云
...
## 相关文档
- 关于拷贝文件的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-android-sdk/blob/master/oss-android-sdk/src/androidTest/java/com/alibaba/sdk/android/ManageObjectTest.java)。
...
[上一篇：获取文件访问权限（Android SDK）](/zh/oss/developer-reference/query-the-acl-of-an-object)[下一篇：列举文件（Android SDK）](/zh/oss/developer-reference/list-objects-4)该文章对您有帮助吗？反馈
