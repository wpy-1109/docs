...
| --- | --- | --- | --- |
| ReplicationRules | Container | Yes | The container that is used to store the data replication rule to delete. Parent nodes: noneChild nodes: ID |
| ID | String | Yes | The ID of data replication rule to delete. You can call GetBucketReplication to obtain the ID. Parent nodes: ReplictionRulesChild nodes: none |
...
For information about the ossutil command that corresponds to the DeleteBucketReplication operation, see [delete-bucket-replication](https://www.alibabacloud.com/help/en/oss/developer-reference/delete-bucket-replication).
