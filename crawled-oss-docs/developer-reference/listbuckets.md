# Call GetService (ListBuckets) to list buckets
...
For more information, see [Attach a custom policy to a RAM user](https://www.alibabacloud.com/help/en/oss/user-guide/common-examples-of-ram-policies#section-ucu-jv0-zip).
...
All headers in the response to a ListBuckets (GetService) request are common response headers. For more information, see [Common response headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-hcd-m2y-wdb).
...
| --- | --- | --- | --- |
| ListAllMyBucketsResult | Container | N/A | The container that stores the results of the ListBuckets (GetService) request. Child nodes: Owner and BucketsParent nodes: none |
...
| Buckets | Container | N/A | The container that stores information about multiple buckets. Child nodes: BucketParent nodes: ListAllMyBucketsResult |
| Bucket | Container | N/A | The container that stores information about the bucket. Child nodes: Name, CreationDate, and LocationParent nodes: ListAllMyBucketsResult.Buckets |
...
[Java](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets#concept-2348405)
...
[C](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-9#concept-2365059)

-

[C++](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-3#concept-2351976)

-

[.NET](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-using-oss-sdk-for-csharp-v1#concept-2372520)

-

[iOS](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-10#concept-2056668)

-

[Node.js](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-8#concept-2380378)

-

[Ruby](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-7#concept-2382491)

## ossutil


For information about the ossutil command that corresponds to the ListBuckets operation, see [list-buckets (get-service)](https://www.alibabacloud.com/help/en/oss/developer-reference/list-buckets-get-service).
