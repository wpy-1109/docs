# Query the configurations of access point policies by calling the GetAccessPointPolicy operation
...
The response to a GetAccessPointPolicy request contains only common response headers. For more information, see [Common HTTP headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-hcd-m2y-wdb).
...
For information about the ossutil command that corresponds to the GetAccessPointPolicy operation, see [get-access-point-policy](https://www.alibabacloud.com/help/en/oss/developer-reference/get-access-point-policy).
