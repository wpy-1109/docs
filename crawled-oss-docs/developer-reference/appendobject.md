...
You cannot use the AppendObject operation on objects that are protected by a [retention policy](https://www.alibabacloud.com/help/en/oss/user-guide/oss-retention-policies#concept-lnj-4rl-cfb).
...
| --- | --- | --- |
| AppendObject | oss:PutObject | You can call this operation to upload an object by appending the object to an existing object. |
| oss:PutObjectTagging | When uploading an object by appending the object to an existing object, if you specify object tags through x-oss-tagging, this permission is required. |
...
| x-oss-tagging | string | No | TagA=A | Specifies the tags of the object in a key-value format. You can specify multiple tags at the same time, such as TagA=A&TagB=B.Important This request header takes effect only for the first append operation. It does not take effect for subsequent append operations.The key and value must be URL-encoded. The key is required, but the value is optional. For example, you can set the object tags to TagA&TagB=B. |


For more information about other common request headers for this operation, see [Common request headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-eq1-b2y-wdb).
...
The append and position parameters are part of the [CanonicalizedResource](https://www.alibabacloud.com/help/en/oss/developer-reference/include-signatures-in-the-authorization-header#concept-aml-vv2-xdb) and must be included in the signature.
...
For more information about other common response headers for this operation, see [Common response headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-hcd-m2y-wdb).
...
| --- | --- |
| PutObject | If you perform a PutObject operation on an existing Appendable object, the Appendable object is overwritten by the new object, and its type is changed to Normal. |
| HeadObject | A HeadObject operation on an Appendable object returns x-oss-next-append-position, x-oss-hash-crc64ecma, and x-oss-object-type. The x-oss-object-type of an Appendable object is Appendable. |
| GetBucket (ListObjects) | In the response to a GetBucket request, the Type of an Appendable object is set to Appendable. |
...
[Java](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-12#concept-84784-zh)

-

[Python V2](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-using-oss-sdk-for-python-v2)

-

[PHP V2](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-using-oss-sdk-for-php-v2)

-

[Go V2](https://www.alibabacloud.com/help/en/oss/developer-reference/v2-perform-append-upload)

-

[Node.js](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-4)

-

[Harmony](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-using-oss-sdk-for-harmony)

-

[C](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-8#concept-90215-zh)

-

[.NET](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-10#concept-91099-zh)

-

[iOS](https://www.alibabacloud.com/help/en/oss/developer-reference/upload-objects-12/)

-

[Ruby](https://www.alibabacloud.com/help/en/oss/developer-reference/upload-objects-3/)

-

[Browser.js](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-3)

-

[C++](https://www.alibabacloud.com/help/en/oss/developer-reference/append-upload-9)

## ossutil command line interface


To perform this operation using ossutil, see the [append-object](https://www.alibabacloud.com/help/en/oss/developer-reference/append-object) command.
...
| PositionNotEqualToLength | 409 | The value of position does not match the current length of the object.You can obtain the position for the next request from the x-oss-next-append-position response header and try the request again. Due to concurrency, the request may still fail with the PositionNotEqualToLength error even if you set the position to the value of x-oss-next-append-position.If the position is 0, the request is successful if no Appendable object with the same name exists, or if an Appendable object with the same name has a length of 0. In other cases, the position is considered a mismatch with the object length, and this error code is returned. |
