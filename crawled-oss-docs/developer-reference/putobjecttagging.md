# invoke the PutObjectTagging operation to set or update the tagging information of an object
...
For more information about object tags, see [Configure object tagging](https://www.alibabacloud.com/help/en/oss/user-guide/object-tagging-8#concept-zxf-jpy-pgb).
...
| --- | --- | --- | --- | --- |
| Tagging | Container | Yes | N/A | The top-level container. Child nodes: TagSet |
| TagSet | Container | Yes | N/A | The tags. Parent nodes: TaggingChild nodes: Tag |
| Tag | Container | No | N/A | The tag. Parent nodes: TagSet Child nodes: Key and Value |
| Key | String | No | a | The key of the tag. Parent nodes: TagChild nodes: none |
| Value | String | No | 1 | The value of the tag. Parent nodes: TagChild nodes: none |


This operation also involves common request headers. For more information, see [Common HTTP headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-eq1-b2y-wdb).
...
[Java](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-object-tagging-5#concept-727741)

-

[Python](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-object-tagging-3#concept-644876)

-

[Go V2](https://www.alibabacloud.com/help/en/oss/developer-reference/v2-configure-object-tagging)

-

[PHP](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-object-tagging-1)

-

[C++](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-object-tagging-4#concept-727372)

-

[.NET](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-tags-for-objects-using-oss-sdk-for-csharp-v1#concept-2512333)

-

[Node.js](https://www.alibabacloud.com/help/en/oss/developer-reference/configure-object-tagging-6#concept-2404167)
...
For information about the ossutil command that corresponds to the PutObjectTagging operation, see [put-object-tagging](https://www.alibabacloud.com/help/en/oss/developer-reference/put-object-tagging).
...
| --- | --- | --- |
| FileAlreadyExists | 409 | The object for which you want to configure or update tags is a directory within a bucket that has the hierarchical namespace feature enabled. |
