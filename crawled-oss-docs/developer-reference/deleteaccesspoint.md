# Delete an access point by calling the DeleteAccessPoint operation
...
The response to a DeleteAccessPoint request contains only common response headers. For more information, see [Common HTTP headers](https://www.alibabacloud.com/help/en/oss/developer-reference/common-http-headers#section-hcd-m2y-wdb).
...
For information about the ossutil command that corresponds to the DeleteAccessPoint operation, see [delete-access-point](https://www.alibabacloud.com/help/en/oss/developer-reference/delete-access-point).
