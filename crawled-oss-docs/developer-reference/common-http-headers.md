...
(https://www.alibabacloud.com/help/en/ram/developer-reference/api-sts-2015-04-01-assumerole#main-107864)


| Header | Type | Example | Description |
| --- | --- | --- | --- |
| Authorization | String | OSS4-HMAC-SHA256 Credential= | The authentication information that you want to use to verify the validity of the non-anonymous request. For more information about how to calculate the Authorization header, see (Recommended) Include a V4 signature in the Authorization header.By default, this header is left empty. |
...
| Host | String | oss-example.oss-cn-hangzhou.aliyuncs.com | The domain name. The format is BucketName.Endpoint. Example: oss-example.oss-cn-hangzhou.aliyuncs.com. By default, this header is left empty. |
| x-oss-security-token | String |  | This header is required only when you use temporary access credentials to access OSS resources. Otherwise, you can leave this header empty. For more information about how to obtain a security token, see AssumeRole. |
...
(https://www.alibabacloud.com/help/en/oss/user-guide/obtain-request-ids#concept-2087584)
