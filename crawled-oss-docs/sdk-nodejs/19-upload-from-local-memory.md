# 使用Node.js SDK上传内存数据到OSS

Source: https://help.aliyun.com/zh/oss/developer-reference/upload-from-local-memory

---

- 使用Node.js SDK上传内存数据到OSS-对象存储-阿里云
...
[上一篇：上传本地文件（Node.js SDK）](/zh/oss/developer-reference/upload-a-local-file)[下一篇：流式上传（Node.js SDK）](/zh/oss/developer-reference/streaming-upload-1)该文章对您有帮助吗？反馈
