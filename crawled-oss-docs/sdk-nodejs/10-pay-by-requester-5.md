# 使用Node.js SDK设置请求者付费模式并访问Object

Source: https://help.aliyun.com/zh/oss/developer-reference/pay-by-requester-5

---

- 使用Node.js SDK设置请求者付费模式并访问Object-对象存储-阿里云
...
## 相关文档
- 关于请求者付费模式的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994772cq23ae#getbucketrequestpaymentbucketname-options)。
...
- 关于获取请求者付费模式配置信息的API接口说明，请参见[GetBucketRequestPayment](https://help.aliyun.com/zh/oss/developer-reference/getbucketrequestpayment#reference-1340313)。

[上一篇：删除存储空间（Node.js SDK）](/zh/oss/developer-reference/delete-a-bucket-5)[下一篇：存储空间标签（Node.js SDK）](/zh/oss/developer-reference/bucket-tagging-2)该文章对您有帮助吗？反馈
