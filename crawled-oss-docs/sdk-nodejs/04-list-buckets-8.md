# 使用Node.js SDK按条件列举存储空间

Source: https://help.aliyun.com/zh/oss/developer-reference/list-buckets-8

---

- 使用Node.js SDK按条件列举存储空间-对象存储-阿里云
...
## 相关文档
- 关于列举存储空间的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994772cq23ae#listbucketsquery-options)。
...
[上一篇：创建存储空间（Node.js SDK）](/zh/oss/developer-reference/create-a-bucket-4)[下一篇：判断存储空间是否存在（Node.js SDK）](/zh/oss/developer-reference/determine-whether-a-bucket-exists-7)该文章对您有帮助吗？反馈
