# 使用Node.js SDK通过复制Object实现存储类型转换

Source: https://help.aliyun.com/zh/oss/developer-reference/convert-the-storage-classes-of-objects-3

---

- 使用Node.js SDK通过复制Object实现存储类型转换-对象存储-阿里云
...
[上一篇：删除文件（Node.js SDK）](/zh/oss/developer-reference/nodejs-delete-objects)[下一篇：单链接限速（Node.js SDK）](/zh/oss/developer-reference/single-connection-bandwidth-throttling-7)该文章对您有帮助吗？反馈
