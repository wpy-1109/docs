...
Source: https://help.aliyun.com/zh/oss/developer-reference/logging-8

---

- 使用Node.jsSDK管理日志转存-对象存储-阿里云
...
## 相关文档
- 关于日志转存的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994772cq23ae#putbucketloggingname-prefix-options)。
...
[上一篇：静态网站托管（镜像回源）（Node.js SDK）](/zh/oss/developer-reference/static-website-hosting-7)[下一篇：传输管理（Node.js SDK）](/zh/oss/developer-reference/transmission-management-1/)该文章对您有帮助吗？反馈
