# 使用Node.jsSDK设置上传下载文件的单链接限速

Source: https://help.aliyun.com/zh/oss/developer-reference/single-connection-bandwidth-throttling-7

---

- 使用Node.jsSDK设置上传下载文件的单链接限速-对象存储-阿里云
...
关于单链接限速的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994772cq23ae#signatureurlname-options)。

[上一篇：转换文件存储类型（Node.js SDK）](/zh/oss/developer-reference/convert-the-storage-classes-of-objects-3)[下一篇：解冻文件（Node.js SDK）](/zh/oss/developer-reference/restore-objects-11)该文章对您有帮助吗？反馈
