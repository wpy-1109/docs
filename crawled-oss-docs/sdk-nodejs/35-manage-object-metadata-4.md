# 通过Node.js SDK设置修改与获取文件元数据

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-object-metadata-4

---

- 通过Node.js SDK设置修改与获取文件元数据-对象存储-阿里云
...
使用`put`、`putStream`和`multipartUpload`时，都可以通过指定meta参数来指定文件的元数据：
...
[上一篇：判断文件是否存在（Node.js SDK）](/zh/oss/developer-reference/determine-whether-an-object-exists-2)[下一篇：列举文件（Node.js SDK）](/zh/oss/developer-reference/list-objects-5)该文章对您有帮助吗？反馈
