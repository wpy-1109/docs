# 通过Node.js SDK流式上传文件流与网络流

Source: https://help.aliyun.com/zh/oss/developer-reference/streaming-upload-1

---

- 通过Node.js SDK流式上传文件流与网络流-对象存储-阿里云
...
关于流式上传的完整示例代码，请参见[GitHub示例](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994f59sZVNO5#putstreamname-stream-options)。

[上一篇：上传本地内存（Node.js SDK）](/zh/oss/developer-reference/upload-from-local-memory)[下一篇：分片上传（Node.js SDK）](/zh/oss/developer-reference/multipart-upload-3)该文章对您有帮助吗？反馈
