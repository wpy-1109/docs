# 使用Node.js SDK在开启版本控制的Bucket中上传文件

Source: https://help.aliyun.com/zh/oss/developer-reference/upload-objects-13

---

- 使用Node.js SDK在开启版本控制的Bucket中上传文件-对象存储-阿里云
...
[上一篇：管理版本控制（Node.js SDK）](/zh/oss/developer-reference/versioning-9)[下一篇：下载文件（Node.js SDK）](/zh/oss/developer-reference/download-objects-16)该文章对您有帮助吗？反馈
