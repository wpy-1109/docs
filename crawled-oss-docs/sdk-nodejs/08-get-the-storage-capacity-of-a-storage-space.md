# 使用Node.js SDK获取Bucket存储统计信息

Source: https://help.aliyun.com/zh/oss/developer-reference/get-the-storage-capacity-of-a-storage-space

---

- 使用Node.js SDK获取Bucket存储统计信息-对象存储-阿里云
...
要获取存储空间的存储容量，您必须有`oss:GetBucketStat`权限。具体操作，请参见[RAM Policy常见示例](https://help.aliyun.com/zh/oss/user-guide/common-examples-of-ram-policies#section-ucu-jv0-zip)。

## 示例代码

以下代码用于获取examplebucket的总存储容量以及该Bucket内不同存储类型Object的数量及其存储容量。
重要 
仅Node.js SDK 6.18.0及以上版本支持返回以下示例代码中包含的所有属性。
...
关于获取指定Bucket的存储容量以及该Bucket内不同存储类型Object的数量及其存储容量的API接口说明，请参见[GetBucketStat](https://help.aliyun.com/zh/oss/developer-reference/getbucketstat#reference-2205923)。

[上一篇：获取存储空间的信息（Node.js SDK）](/zh/oss/developer-reference/query-bucket-information-5)[下一篇：删除存储空间（Node.js SDK）](/zh/oss/developer-reference/delete-a-bucket-5)该文章对您有帮助吗？反馈
