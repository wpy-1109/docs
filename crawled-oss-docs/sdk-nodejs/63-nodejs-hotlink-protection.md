# 使用Node.js SDK配置Referer防盗链规则

Source: https://help.aliyun.com/zh/oss/developer-reference/nodejs-hotlink-protection

---

- 使用Node.js SDK配置Referer防盗链规则-对象存储-阿里云
...
- 本文以OSS域名新建OSSClient为例。如果您希望通过自定义域名、STS等方式新建OSSClient，请参见[初始化（Node.js SDK）](https://help.aliyun.com/zh/oss/initialization-10)。
...
## 相关文档
- 关于防盗链的完整示例代码，请参见[GitHub](https://github.com/ali-sdk/ali-oss?spm=a2c4g.11186623.0.0.13994772cq23ae#putbucketreferername-allowempty-referers-options)。
...
[上一篇：管理软链接（Node.js SDK）](/zh/oss/developer-reference/manage-symbolic-links-13)[下一篇：跨域资源共享（Node.js SDK）](/zh/oss/developer-reference/cors-8)该文章对您有帮助吗？反馈
