...
Source: https://help.aliyun.com/zh/oss/developer-reference/append-upload-10

---

- 使用C# SDK实现文件追加上传-对象存储-阿里云
...
## 相关文档
- 关于追加上传的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/AppendObjectSample.cs)。
- 关于追加上传的API接口说明，请参见[AppendObject](https://help.aliyun.com/zh/oss/developer-reference/appendobject#reference-fvf-xld-5db)。

[上一篇：简单上传（C# SDK V1）](/zh/oss/developer-reference/simple-upload-9)[下一篇：断点续传上传（C# SDK V1）](/zh/oss/developer-reference/resumable-upload-8)该文章对您有帮助吗？反馈
