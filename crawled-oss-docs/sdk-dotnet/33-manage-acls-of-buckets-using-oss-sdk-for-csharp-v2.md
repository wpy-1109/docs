# 使用C# SDK V2设置和获取存储空间读写权限

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-acls-of-buckets-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2设置和获取存储空间读写权限-对象存储-阿里云
...
## 相关文档
- 关于设置存储空间读写权限的完整示例代码，请参见[PutBucketAcl.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/PutBucketAcl/Program.cs)。
- 关于获取存储空间读写权限的完整示例代码，请参见[GetBucketAcl.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetBucketAcl/Program.cs)。

[上一篇：权限控制（C# SDK V2）](/zh/oss/developer-reference/permission-control-using-oss-sdk-for-c-v2/)[下一篇：管理文件访问权限（C# SDK V2）](/zh/oss/developer-reference/manage-acls-of-objects-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
