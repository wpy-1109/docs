# 使用C# SDK V2设置与获取文件访问权限

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-acls-of-objects-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2设置与获取文件访问权限-对象存储-阿里云
...
## 相关文档
- 关于设置文件读写权限的完整示例代码，请参见[PutObjectAcl.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/PutObjectAcl/Program.cs)。
- 关于获取文件读写权限的完整示例代码，请参见[GetObjectAcl.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetObjectAcl/Program.cs)。

[上一篇：管理存储空间读写权限（C# SDK V2）](/zh/oss/developer-reference/manage-acls-of-buckets-using-oss-sdk-for-csharp-v2)[下一篇：数据安全（C# SDK V2）](/zh/oss/developer-reference/data-security-oss-sdk-for-c-2-0/)该文章对您有帮助吗？反馈
