...
Source: https://help.aliyun.com/zh/oss/developer-reference/list-buckets-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2列举存储空间-对象存储-阿里云
...
关于列举存储空间的完整示例代码，请参见[list_buckets.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/ListBuckets/Program.cs)。

[上一篇：创建存储空间（C# SDK V2）](/zh/oss/developer-reference/create-buckets-using-oss-sdk-for-csharp-v2)[下一篇：判断存储空间是否存在（C# SDK V2）](/zh/oss/developer-reference/determine-whether-the-bucket-exists-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
