...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-objects-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2删除单个和多个对象-对象存储-阿里云
...
本文介绍如何使用OSS C# SDK删除指定的单个文件和删除指定的多个文件。
...
- 本文以从环境变量读取访问凭证为例。如何配置访问凭证，请参见[配置访问凭证](https://help.aliyun.com/zh/oss/developer-reference/configure-access-credentials-using-oss-sdk-for-csharp-v2#2e77e67568y99)。
...
var key = "your object name";  // 必须项，目标文件对象名称
...
// 打印结果信息
Console.WriteLine("DeleteObject done");   // 提示操作完成
...
var keys = new List  // 必须项，需删除的目标对象
{
    "your object key1",
    "your object key2",
    "your object key3"
...
// 调用DeleteMultipleObjectsAsync方法，执行批量删除请求
...
keys?.ToList().ForEach(x => Console.WriteLine(x));  // 打印已删除的对象列表
```

## 相关文档

关于删除文件的完整示例代码，请参见[delete_object.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/DeleteObject/Program.cs)。

[上一篇：列举文件（C# SDK V2）](/zh/oss/developer-reference/list-objects-using-oss-sdk-for-csharp-v2)[下一篇：管理软链接（C# SDK V2）](/zh/oss/developer-reference/manage-symbolic-links-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
