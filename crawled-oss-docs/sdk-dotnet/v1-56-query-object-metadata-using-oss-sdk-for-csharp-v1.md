...
Source: https://help.aliyun.com/zh/oss/developer-reference/query-object-metadata-using-oss-sdk-for-csharp-v1

---

- 使用C# SDK获取指定版本文件元数据-对象存储-阿里云
...
[上一篇：解冻文件（C# SDK V1）](/zh/oss/developer-reference/restore-objects-6)[下一篇：管理文件访问权限（C# SDK V1）](/zh/oss/developer-reference/manage-object-acls-7)该文章对您有帮助吗？反馈
