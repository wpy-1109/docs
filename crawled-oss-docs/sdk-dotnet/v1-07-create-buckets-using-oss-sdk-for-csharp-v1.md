# 使用C#SDK创建存储空间并指定初始配置

Source: https://help.aliyun.com/zh/oss/developer-reference/create-buckets-using-oss-sdk-for-csharp-v1

---

- 使用C#SDK创建存储空间并指定初始配置-对象存储-阿里云
...
## 相关文档
- 关于创建存储空间的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/CreateBucketSample.cs)。
- 关于创建存储空间的API接口说明，请参见[PutBucket](https://help.aliyun.com/zh/oss/developer-reference/putbucket#reference-wdh-fj5-tdb)。

[上一篇：存储空间（C# SDK V1）](/zh/oss/developer-reference/manage-buckets-using-oss-sdk-for-csharp-v1/)[下一篇：列举存储空间（C# SDK V1）](/zh/oss/developer-reference/list-buckets-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
