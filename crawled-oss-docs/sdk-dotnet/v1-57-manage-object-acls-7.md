# 通过C# SDK V1设置和获取指定版本文件的访问权限

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-object-acls-7

---

- 通过C# SDK V1设置和获取指定版本文件的访问权限-对象存储-阿里云
...
[上一篇：获取文件元数据（C# SDK V1）](/zh/oss/developer-reference/query-object-metadata-using-oss-sdk-for-csharp-v1)[下一篇：管理软链接（C# SDK V1）](/zh/oss/developer-reference/manage-symbolic-links-9)该文章对您有帮助吗？反馈
