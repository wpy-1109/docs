# 使用C# SDK V2下载版本控制Bucket中的指定版本文件

Source: https://help.aliyun.com/zh/oss/developer-reference/download-objects-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2下载版本控制Bucket中的指定版本文件-对象存储-阿里云
...
本文介绍如何使用C# SDK V2在开启版本控制的存储空间（Bucket）中下载文件（Object）。
...
var versionId = "your object versionId";  // 必须项，指定下载对象的x-oss-version-id
...
[上一篇：上传文件（C# SDK V2）](/zh/oss/developer-reference/upload-object-using-oss-sdk-for-csharp-v2)[下一篇：拷贝文件（C# SDK V2）](/zh/oss/developer-reference/copy-object-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
