...
Source: https://help.aliyun.com/zh/oss/developer-reference/append-upload-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2追加上传文件-对象存储-阿里云
...
关于追加上传的完整示例代码，请参见[AppendObject.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/AppendObject/Program.cs)。

[上一篇：简单上传（C# SDK V2）](/zh/oss/developer-reference/simple-upload-using-oss-sdk-for-csharp-v2)[下一篇：分片上传（C# SDK V2）](/zh/oss/developer-reference/multipart-upload-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
