# 使用C# SDK在上传和拷贝文件时设置对象标签

Source: https://help.aliyun.com/zh/oss/developer-reference/configure-tags-for-objects-using-oss-sdk-for-csharp-v1

---

- 使用C# SDK在上传和拷贝文件时设置对象标签-对象存储-阿里云
...
[上一篇：对象标签（C# SDK V1）](/zh/oss/developer-reference/tag-objects-using-oss-sdk-for-csharp-v1/)[下一篇：获取对象标签（C# SDK V1）](/zh/oss/developer-reference/query-the-tags-of-an-object-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
