...
Source: https://help.aliyun.com/zh/oss/developer-reference/query-the-region-of-the-bucket-using-oss-sdk-for-csharp-v2

---

- 获取存储空间地域(C# SDK V2)-对象存储-阿里云
...
- 本文以从环境变量读取访问凭证为例。如何配置访问凭证，请参见【.net 2.0配置访问凭证文档】。
...
// 调用GetBucketLocationAsync方法，获取指定Bucket的地域信息 
...
Console.WriteLine($"Location: {result.LocationConstraint}");  //打印Bucket所属地域 
```

## 相关文档

关于获取存储空间地域的完整示例代码，请参见[GetBucketLocation.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetBucketLocation/Program.cs)。

[上一篇：判断存储空间是否存在（C# SDK V2）](/zh/oss/developer-reference/determine-whether-the-bucket-exists-using-oss-sdk-for-csharp-v2)[下一篇：获取存储空间的信息（C# SDK V2）](/zh/oss/developer-reference/query-bucket-information-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
