# 使用C#为生命周期规则添加对象标签匹配条件

Source: https://help.aliyun.com/zh/oss/developer-reference/use-object-tagging-for-lifecycle-management

---

- 使用C#为生命周期规则添加对象标签匹配条件-对象存储-阿里云
...
## 相关文档
- 关于生命周期规则的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/GetBucketLifecycleSample.cs)。
...
[上一篇：删除对象标签（C# SDK V1）](/zh/oss/developer-reference/delete-object-tags)[下一篇：管理软链接（C# SDK V1）](/zh/oss/developer-reference/manage-symbolic-links-16)该文章对您有帮助吗？反馈
