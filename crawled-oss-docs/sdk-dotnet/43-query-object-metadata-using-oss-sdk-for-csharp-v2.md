...
Source: https://help.aliyun.com/zh/oss/developer-reference/query-object-metadata-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2获取对象元数据-对象存储-阿里云
...
## 相关文档
- 关于获取对象完整元数据示例代码，请参见[HeadObject.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/HeadObject/Program.cs)。
- 关于获取对象部分元数据示例代码，请参见[GetObjectMeta.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetObjectMeta/Program.cs)。

[上一篇：管理文件访问权限（C# SDK V2）](/zh/oss/developer-reference/manage-acls-of-object-using-oss-sdk-for-csharp-v2)[下一篇：数据处理（C# SDK V2）](/zh/oss/developer-reference/data-processing-with-oss-sdk-for-c-2-0/)该文章对您有帮助吗？反馈
