# 使用C# SDK V2拷贝小于5GiB的对象

Source: https://help.aliyun.com/zh/oss/developer-reference/copy-objects-using-oss-sdk-for-c-v2

---

- 使用C# SDK V2拷贝小于5GiB的对象-对象存储-阿里云
...
本文介绍如何使用C# SDK V2的CopyObjectAsync方法，将源Bucket中的对象（5GiB 以下）拷贝到同一地域下相同或不同目标Bucket中。
...
关于拷贝对象的完整示例代码，请参见[CopyObject.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/CopyObject/Program.cs)。

[上一篇：拷贝文件（C# SDK V2）](/zh/oss/developer-reference/copy-file-using-oss-sdk-for-c-v2/)[下一篇：管理文件（C# SDK V2）](/zh/oss/developer-reference/manage-files-using-oss-sdk-for-c-v2/)该文章对您有帮助吗？反馈
