...
Source: https://help.aliyun.com/zh/oss/developer-reference/upload-objects-to-version-bucket-using-oss-sdk-for-csharp-v1

---

- 上传文件（C# SDK V1）-对象存储-阿里云
...
[上一篇：管理版本控制（C# SDK V1）](/zh/oss/developer-reference/versioning-4)[下一篇：下载文件（C# SDK V1）](/zh/oss/developer-reference/download-objects-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
