...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-tags-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2删除指定对象的标签-对象存储-阿里云
...
- 对象标签使用一组键值对（Key-Value）来标记对象。关于对象标签的更多信息，请参见开发指南中的[对象标签](https://help.aliyun.com/zh/oss/user-guide/object-tagging-8#concept-zxf-jpy-pgb)。
...
关于删除对象标签的完整示例代码，请参见[DeleteObjectTagging.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/DeleteObjectTagging/Program.cs)。

[上一篇：获取对象标签（C# SDK V2）](/zh/oss/developer-reference/query-the-tags-of-an-object-using-oss-sdk-for-csharp-v2)[下一篇：权限控制（C# SDK V2）](/zh/oss/developer-reference/permission-control-using-oss-sdk-for-c-v2/)该文章对您有帮助吗？反馈
