...
Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-16

---

- 使用C# SDK创建软链接并获取其目标-对象存储-阿里云
...
[上一篇：对象标签和生命周期管理（C# SDK V1）](/zh/oss/developer-reference/use-object-tagging-for-lifecycle-management)[下一篇：数据安全（C# SDK V1）](/zh/oss/developer-reference/data-security-oss-sdk-for-csharp-v1/)该文章对您有帮助吗？反馈
