...
Source: https://help.aliyun.com/zh/oss/developer-reference/resumable-download-4

---

- 使用C# SDK断点续传下载大文件-对象存储-阿里云
...
[上一篇：范围下载（C# SDK V1）](/zh/oss/developer-reference/range-download-4)[下一篇：使用预签名URL下载（C# SDK V1）](/zh/oss/developer-reference/download-objects-using-presigned-urls-generated-with-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
