...
Source: https://help.aliyun.com/zh/oss/developer-reference/copy-objects-in-version-bucket-using-oss-sdk-for-csharp-v1

---

- 使用C# SDK实现文件拷贝与分片拷贝-对象存储-阿里云
...
[上一篇：下载文件（C# SDK V1）](/zh/oss/developer-reference/download-objects-using-oss-sdk-for-csharp-v1)[下一篇：删除文件（C# SDK V1）](/zh/oss/developer-reference/delete-objects-8)该文章对您有帮助吗？反馈
