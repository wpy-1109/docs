# 使用C# SDK V1管理存储空间清单配置

Source: https://help.aliyun.com/zh/oss/developer-reference/bucket-inventory-2

---

- 使用C# SDK V1管理存储空间清单配置-对象存储-阿里云
...
[上一篇：生命周期（C# SDK V1）](/zh/oss/developer-reference/lifecycle-rules-2)[下一篇：静态网站托管（C# SDK V1）](/zh/oss/developer-reference/static-website-hosting)该文章对您有帮助吗？反馈
