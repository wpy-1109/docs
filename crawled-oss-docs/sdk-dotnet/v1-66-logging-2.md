...
Source: https://help.aliyun.com/zh/oss/developer-reference/logging-2

---

- 使用C# SDK配置访问日志转存-对象存储OSS-阿里云
...
## 相关文档
- 关于日志转存的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/SetBucketLoggingSample.cs)。
...
[上一篇：静态网站托管（C# SDK V1）](/zh/oss/developer-reference/static-website-hosting)[下一篇：图片处理（C# SDK V1）](/zh/oss/developer-reference/img-3)该文章对您有帮助吗？反馈
