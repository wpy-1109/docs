...
Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-6

---

- 使用C# SDK解冻指定版本的归档文件-对象存储-阿里云
...
关于解冻文件的API接口说明，请参见[RestoreObject](https://help.aliyun.com/zh/oss/developer-reference/restoreobject#reference-mfr-5bx-wdb)。

[上一篇：删除文件（C# SDK V1）](/zh/oss/developer-reference/delete-objects-8)[下一篇：获取文件元数据（C# SDK V1）](/zh/oss/developer-reference/query-object-metadata-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
