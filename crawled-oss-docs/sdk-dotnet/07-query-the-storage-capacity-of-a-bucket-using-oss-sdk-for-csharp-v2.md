# 使用C# SDK V2获取存储空间统计信息

Source: https://help.aliyun.com/zh/oss/developer-reference/query-the-storage-capacity-of-a-bucket-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2获取存储空间统计信息-对象存储-阿里云
...
关于获取存储空间信息的完整示例代码，请参见[GetBucketStat.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetBucketStat/Program.cs)。

[上一篇：获取存储空间的信息（C# SDK V2）](/zh/oss/developer-reference/query-bucket-information-using-oss-sdk-for-csharp-v2)[下一篇：删除存储空间（C# SDK V2）](/zh/oss/developer-reference/delete-buckets-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
