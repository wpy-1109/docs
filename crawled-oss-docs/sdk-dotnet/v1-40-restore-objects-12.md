# 使用C# SDK解冻归档和冷归档Object

Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-12

---

- 使用C# SDK解冻归档和冷归档Object-对象存储-阿里云
...
## 相关文档
- 关于解冻归档和冷归档Object的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/RestoreArchiveObjectSample.cs)。
- 关于解冻归档和冷归档Object的API接口描述，请参见[RestoreObject](https://help.aliyun.com/zh/oss/developer-reference/restoreobject#reference-mfr-5bx-wdb)。

[上一篇：拷贝文件（C# SDK V1）](/zh/oss/developer-reference/copy-objects-using-oss-sdk-for-csharp-v1)[下一篇：单链接限速（C# SDK V1）](/zh/oss/developer-reference/single-connection-bandwidth-throttling-2)该文章对您有帮助吗？反馈
