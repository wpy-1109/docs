...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-buckets-2

---

- 使用C#SDK删除存储空间Bucket-对象存储-阿里云
...
## 相关文档
- [GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/DeleteBucketSample.cs)。
- 关于删除Bucket的API接口说明，请参见[DeleteBucket](https://help.aliyun.com/zh/oss/developer-reference/deletebucket#reference-o1j-rrw-tdb)。

[上一篇：获取存储空间的信息（C# SDK V1）](/zh/oss/developer-reference/query-bucket-information-using-oss-sdk-for-csharp-v1)[下一篇：存储空间标签（C# SDK V1）](/zh/oss/developer-reference/bucket-tagging-1)该文章对您有帮助吗？反馈
