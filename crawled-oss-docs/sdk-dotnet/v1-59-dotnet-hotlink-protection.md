...
Source: https://help.aliyun.com/zh/oss/developer-reference/dotnet-hotlink-protection

---

- 使用C# SDK配置Referer防盗链-对象存储-阿里云
...
## 相关文档
- 关于防盗链的完整示例代码，请参见[GitHub](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/SetBucketRefererSample.cs)。
...
[上一篇：管理软链接（C# SDK V1）](/zh/oss/developer-reference/manage-symbolic-links-9)[下一篇：跨域资源共享（C# SDK V1）](/zh/oss/developer-reference/cors-9)该文章对您有帮助吗？反馈
