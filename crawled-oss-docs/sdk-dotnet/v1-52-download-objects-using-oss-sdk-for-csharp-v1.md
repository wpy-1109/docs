...
Source: https://help.aliyun.com/zh/oss/developer-reference/download-objects-using-oss-sdk-for-csharp-v1

---

- 使用C# SDK V1下载文件的指定版本-对象存储-阿里云
...
[上一篇：上传文件（C# SDK V1）](/zh/oss/developer-reference/upload-objects-to-version-bucket-using-oss-sdk-for-csharp-v1)[下一篇：拷贝文件（C# SDK V1）](/zh/oss/developer-reference/copy-objects-in-version-bucket-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
