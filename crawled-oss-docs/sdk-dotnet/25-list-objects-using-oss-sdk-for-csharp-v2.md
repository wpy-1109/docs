# 使用C# SDK V2列举存储空间中的所有文件

Source: https://help.aliyun.com/zh/oss/developer-reference/list-objects-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2列举存储空间中的所有文件-对象存储-阿里云
...
本文介绍如何使用OSS C# SDK列举指定存储空间（Bucket）下的所有文件。
...
关于列举文件的完整示例代码，请参见[ListObjects.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/ListObjectsV2/Program.cs)。

[上一篇：判断文件是否存在（C# SDK V2）](/zh/oss/developer-reference/determine-whether-an-object-exists-using-oss-sdk-for-csharp-v2)[下一篇：删除文件（C# SDK V2）](/zh/oss/developer-reference/delete-objects-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
