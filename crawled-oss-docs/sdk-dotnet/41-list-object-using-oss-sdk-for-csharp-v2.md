...
Source: https://help.aliyun.com/zh/oss/developer-reference/list-object-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2列举文件版本-对象存储-阿里云
...
- 要列举文件，您必须有`oss:ListObjectVersions`权限。具体操作，请参见[为RAM用户授予自定义的权限策略](https://help.aliyun.com/zh/oss/user-guide/common-examples-of-ram-policies#section-ucu-jv0-zip)。
...
[上一篇：拷贝文件（C# SDK V2）](/zh/oss/developer-reference/copy-object-using-oss-sdk-for-csharp-v2)[下一篇：管理文件访问权限（C# SDK V2）](/zh/oss/developer-reference/manage-acls-of-object-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
