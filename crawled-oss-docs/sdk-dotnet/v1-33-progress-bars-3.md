...
Source: https://help.aliyun.com/zh/oss/developer-reference/progress-bars-3

---

- 使用C#SDK下载文件时显示进度条-对象存储-阿里云
...
关于下载文件的进度条使用方法的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/ProgressSample.cs)。

[上一篇：使用预签名URL下载（C# SDK V1）](/zh/oss/developer-reference/download-objects-using-presigned-urls-generated-with-oss-sdk-for-csharp-v1)[下一篇：管理文件（C# SDK V1）](/zh/oss/developer-reference/manage-objects-using-oss-sdk-for-csharp-v1/)该文章对您有帮助吗？反馈
