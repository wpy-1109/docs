# 使用C# SDK设置和获取存储空间读写权限

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-bucket-acls-3

---

- 使用C# SDK设置和获取存储空间读写权限-对象存储-阿里云
...
## 相关文档
- 关于设置存储空间读写权限的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/SetObjectAclSample.cs)。
- 关于获取存储空间读写权限的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/GetObjectAclSample.cs)
...
[上一篇：使用预签名URL上传（C# SDK V1）](/zh/oss/developer-reference/upload-objects-using-presigned-urls-generated-with-sdk-for-net)[下一篇：管理文件访问权限（C# SDK V1）](/zh/oss/developer-reference/manage-object-acls-13)该文章对您有帮助吗？反馈
