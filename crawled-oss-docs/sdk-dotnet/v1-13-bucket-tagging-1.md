...
Source: https://help.aliyun.com/zh/oss/developer-reference/bucket-tagging-1

---

- 使用C# SDK V1管理存储空间标签-对象存储-阿里云
...
[上一篇：删除存储空间（C# SDK V1）](/zh/oss/developer-reference/delete-buckets-2)[下一篇：请求者付费模式（C# SDK V1）](/zh/oss/developer-reference/configure-pay-by-requester-via-oss-sdk-for-csharp)该文章对您有帮助吗？反馈
