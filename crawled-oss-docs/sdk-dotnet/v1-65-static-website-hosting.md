...
Source: https://help.aliyun.com/zh/oss/developer-reference/static-website-hosting

---

- 使用C#SDK配置存储空间托管静态网站-对象存储-阿里云
...
## 相关文档
- 关于静态网站托管的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/SetBucketWetbsiteSample.cs)。
...
[上一篇：存储空间清单（C# SDK V1）](/zh/oss/developer-reference/bucket-inventory-2)[下一篇：日志转存（C# SDK V1）](/zh/oss/developer-reference/logging-2)该文章对您有帮助吗？反馈
