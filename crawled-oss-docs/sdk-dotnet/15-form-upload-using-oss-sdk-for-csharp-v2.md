...
Source: https://help.aliyun.com/zh/oss/developer-reference/form-upload-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2实现表单上传文件-对象存储-阿里云
...
关于表单上传的完整示例，请参见[postObject.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/dev-2505/sample/PostObject/Program.cs)。

[上一篇：分片上传（C# SDK V2）](/zh/oss/developer-reference/multipart-upload-using-oss-sdk-for-csharp-v2)[下一篇：使用预签名URL上传（C# SDK V2）](/zh/oss/developer-reference/upload-objects-using-presigned-urls-generated-with-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
