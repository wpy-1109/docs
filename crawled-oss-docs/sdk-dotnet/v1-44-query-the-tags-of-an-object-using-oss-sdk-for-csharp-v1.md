...
Source: https://help.aliyun.com/zh/oss/developer-reference/query-the-tags-of-an-object-using-oss-sdk-for-csharp-v1

---

- 使用C# SDK获取OSS对象标签-对象存储-阿里云
...
[上一篇：设置对象标签（C# SDK V1）](/zh/oss/developer-reference/configure-tags-for-objects-using-oss-sdk-for-csharp-v1)[下一篇：删除对象标签（C# SDK V1）](/zh/oss/developer-reference/delete-object-tags)该文章对您有帮助吗？反馈
