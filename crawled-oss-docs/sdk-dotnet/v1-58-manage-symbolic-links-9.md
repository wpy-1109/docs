# 使用C# SDK为版本控制Bucket创建和获取软链接

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-symbolic-links-9

---

- 使用C# SDK为版本控制Bucket创建和获取软链接-对象存储-阿里云
...
[上一篇：管理文件访问权限（C# SDK V1）](/zh/oss/developer-reference/manage-object-acls-7)[下一篇：防盗链（C# SDK V1）](/zh/oss/developer-reference/dotnet-hotlink-protection)该文章对您有帮助吗？反馈
