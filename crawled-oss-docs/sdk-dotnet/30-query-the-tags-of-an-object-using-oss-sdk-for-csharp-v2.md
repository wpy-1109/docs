...
Source: https://help.aliyun.com/zh/oss/developer-reference/query-the-tags-of-an-object-using-oss-sdk-for-csharp-v2

---

- 使用C# SDK V2获取对象标签-对象存储-阿里云
...
var key = "your object name";  // 必须项，目标对象文件名称，格式（folder/objectName）
...
// 调用GetObjectTaggingAsync方法，获取目标对象文件的标签信息
...
result.Tagging?.TagSet?.Tags?.ForEach(x => Console.WriteLine(x.Key + " : " + x.Value));  // 若目标对象文件的标签信息存在则打印
```

## 相关文档

关于获取对象标签的完整示例代码，请参见请参见[GetObjectTagging.cs](https://github.com/aliyun/alibabacloud-oss-csharp-sdk-v2/blob/master/sample/GetObjectTagging/Program.cs)。

[上一篇：设置对象标签（C# SDK V2）](/zh/oss/developer-reference/configure-tags-for-objects-using-oss-sdk-for-csharp-v2)[下一篇：删除对象标签（C# SDK V2）](/zh/oss/developer-reference/delete-tags-using-oss-sdk-for-csharp-v2)该文章对您有帮助吗？反馈
