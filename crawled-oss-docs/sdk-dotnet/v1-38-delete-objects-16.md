...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-objects-16

---

- 使用C# SDK单个或批量删除文件-对象存储-阿里云
...
- 简单模式（quiet）：设置quietMode为true，OSS不返回消息体。
...
## 相关文档
- 删除单个文件关于删除单个文件的API接口说明，请参见[DeleteObject](https://help.aliyun.com/zh/oss/developer-reference/deleteobject#reference-iqc-mqv-wdb)。
- 批量删除文件关于批量删除文件的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/DeleteObjectsSample.cs)。
- 关于批量删除文件的API接口说明，请参见[DeleteMultipleObjects](https://help.aliyun.com/zh/oss/developer-reference/deletemultipleobjects#reference-ydg-25v-wdb)。

[上一篇：列举文件（C# SDK V1）](/zh/oss/developer-reference/list-objects-15)[下一篇：拷贝文件（C# SDK V1）](/zh/oss/developer-reference/copy-objects-using-oss-sdk-for-csharp-v1)该文章对您有帮助吗？反馈
