...
Source: https://help.aliyun.com/zh/oss/developer-reference/progress-bars-6

---

- 使用C#SDK在上传对象时显示进度条-对象存储-阿里云
...
进度条用于指示上传或下载的进度。本文以PutObject方法为例，介绍如何使用进度条。
...
关于上传文件时进度条使用方法的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-csharp-sdk/blob/master/samples/Samples/ProgressSample.cs)。

[上一篇：分片上传（C# SDK V1）](/zh/oss/developer-reference/multipart-upload-10)[下一篇：上传回调（C# SDK V1）](/zh/oss/developer-reference/upload-callbacks-9)该文章对您有帮助吗？反馈
