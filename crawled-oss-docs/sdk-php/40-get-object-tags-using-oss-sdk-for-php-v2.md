...
Source: https://help.aliyun.com/zh/oss/developer-reference/get-object-tags-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2获取对象标签-对象存储-阿里云
...
本文介绍如何使用PHP SDK V2获取Object的标签信息。
...
[上一篇：设置对象标签（PHP SDK V2）](/zh/oss/developer-reference/set-object-tags-using-oss-sdk-for-php-v2)[下一篇：删除对象标签（PHP SDK V2）](/zh/oss/developer-reference/delete-object-tags-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
