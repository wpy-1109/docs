...
Source: https://help.aliyun.com/zh/oss/developer-reference/unfreeze-file-1

---

- 使用PHP SDK V2解冻归档文件-对象存储-阿里云
...
- 要解冻文件，您必须有`oss:RestoreObject`权限。具体操作，请参见[为RAM用户授权自定义的权限策略](https://help.aliyun.com/zh/oss/user-guide/common-examples-of-ram-policies#section-ucu-jv0-zip)。
...
[上一篇：删除文件（PHP SDK V2）](/zh/oss/developer-reference/delete-an-versioning-object-using-oss-sdk-for-php-v2)[下一篇：获取文件元数据（PHP SDK V2）](/zh/oss/developer-reference/get-versioning-object-metadata-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
