# 使用PHP SDK V2获取版本化对象的元数据

Source: https://help.aliyun.com/zh/oss/developer-reference/get-versioning-object-metadata-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2获取版本化对象的元数据-对象存储-阿里云
...
[上一篇：解冻文件](/zh/oss/developer-reference/unfreeze-file-1)[下一篇：管理文件访问权限（PHP SDK V2）](/zh/oss/developer-reference/manage-object-acls-in-versioning-bucket-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
