# 使用PHP SDK V2管理Bucket的传输加速功能

Source: https://help.aliyun.com/zh/oss/developer-reference/php-v2-transfer-acceleration

---

- 使用PHP SDK V2管理Bucket的传输加速功能-对象存储-阿里云
...
// 调用getBucketTransferAcceleration方法获取存储空间的传输加速状态
...
printf(
    'status code:' . $result->statusCode . PHP_EOL . // HTTP响应状态码
    'request id:' . $result->requestId . PHP_EOL .   // 请求的唯一标识
    'transfer acceleration status:' . var_export($result->transferAccelerationConfiguration->enabled, true) . PHP_EOL // 传输加速功能是否启用的状态
);

```

## 相关文档
- 关于传输加速的完整代码示例，请参见[put_bucket_transfer_acceleration](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/PutBucketTransferAcceleration.php)和[get_bucket_transfer_acceleration](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/GetBucketTransferAcceleration.php)。
- 关于开启传输加速的API接口说明，请参见[PutBucketTransferAcceleration](https://help.aliyun.com/zh/oss/developer-reference/putbuckettransferacceleration#reference-2076914)。
- 关于查询传输加速状态的API接口说明，请参见[GetBucketTransferAcceleration](https://help.aliyun.com/zh/oss/developer-reference/getbuckettransferacceleration#reference-2076915)。

[上一篇：绑定自定义域名（PHP SDK V2）](/zh/oss/developer-reference/php-v2-map-custom-domain-names)[下一篇：数据处理（PHP SDK V2）](/zh/oss/developer-reference/data-processing-using-oss-sdk-for-php-v2/)该文章对您有帮助吗？反馈
