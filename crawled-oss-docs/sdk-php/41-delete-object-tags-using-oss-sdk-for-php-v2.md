...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-object-tags-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2删除对象标签-对象存储-阿里云
...
本文介绍如何使用PHP SDK V2删除Object的标签信息。
...
[上一篇：获取对象标签（PHP SDK V2）](/zh/oss/developer-reference/get-object-tags-using-oss-sdk-for-php-v2)[下一篇：权限控制（PHP SDK V2）](/zh/oss/developer-reference/permission-control-using-oss-sdk-for-php-v2/)该文章对您有帮助吗？反馈
