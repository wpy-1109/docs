# 使用PHP SDK V2设置与获取请求者付费模式

Source: https://help.aliyun.com/zh/oss/developer-reference/php-v2-pay-by-requester

---

- 使用PHP SDK V2设置与获取请求者付费模式-对象存储-阿里云
...
```
 ['help' => 'The region in which the bucket is located.', 'required' => True], // 地域是必填项，存储空间所在的地域，例如 oss-cn-hangzhou。
...
// 调用getBucketRequestPayment方法获取存储空间请求支付方式
...
printf(
    ...
    'request payer:' . $result->requestPaymentConfiguration->payer // 返回的请求支付方式（BucketOwner 或 Requester）。
);

```

## 相关文档
- 关于设置请求者付费模式的完整示例代码，请参见[Github示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/PutBucketRequestPayment.php)。
...
- 关于获取请求者付费模式配置信息的完整示例代码，请参见[Github示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/GetBucketRequestPayment.php)
- 关于获取请求者付费模式配置信息的API接口，请参见[GetBucketRequestPayment](https://help.aliyun.com/zh/oss/developer-reference/getbucketrequestpayment#reference-1340313)。

[上一篇：存储空间标签（PHP SDK V2）](/zh/oss/developer-reference/php-v2-bucket-tagging)[下一篇：查询Endpoint信息（PHP SDK V2）](/zh/oss/developer-reference/query-endpoint-information-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
