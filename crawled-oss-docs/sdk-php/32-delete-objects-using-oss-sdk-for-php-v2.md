...
Source: https://help.aliyun.com/zh/oss/developer-reference/delete-objects-using-oss-sdk-for-php-v2

---

- 使用PHPSDKV2删除OSS指定文件-对象存储-阿里云
...
## 相关文档
- 关于删除文件的完整示例代码，请参见[Github示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/DeleteObject.php)。

[上一篇：列举文件（PHP SDK V2）](/zh/oss/developer-reference/list-objects-using-oss-sdk-for-php-v2)[下一篇：解冻文件](/zh/oss/developer-reference/restore-object-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
