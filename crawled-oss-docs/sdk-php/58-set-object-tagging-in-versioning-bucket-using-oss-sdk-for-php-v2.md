...
Source: https://help.aliyun.com/zh/oss/developer-reference/set-object-tagging-in-versioning-bucket-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2设置对象标签-对象存储-阿里云
...
OSS支持使用对象标签（Object Tagging）对存储空间（Bucket）中的文件（Object）进行分类，本文介绍如何使用PHP SDK V2在已开启版本控制的存储空间中设置对象标签。
...
[上一篇：对象标签（PHP SDK V2）](/zh/oss/developer-reference/versioning-object-tagging-using-oss-sdk-for-php-v2/)[下一篇：获取对象标签（PHP SDK V2）](/zh/oss/developer-reference/get-object-tagging-in-versioning-bucket-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
