# 使用PHP SDK V2的CopyObject方法拷贝5GiB以下对象

Source: https://help.aliyun.com/zh/oss/developer-reference/copy-object-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2的CopyObject方法拷贝5GiB以下对象-对象存储-阿里云
...
本文介绍如何使用PHP SDK V2的CopyObject方法，将源Bucket中的对象（5GiB 以下）拷贝到同一地域下相同或不同目标Bucket中。
...
## 相关文档
- 关于拷贝对象的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/CopyObject.php)。

[上一篇：拷贝文件（PHP SDK V2）](/zh/oss/developer-reference/copy-file-using-oss-sdk-for-php-v2/)[下一篇：分片拷贝（PHP SDK V2）](/zh/oss/developer-reference/fragment-copy-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
