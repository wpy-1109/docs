# 使用PHP SDK V2查询地域Endpoint信息

Source: https://help.aliyun.com/zh/oss/developer-reference/query-endpoint-information-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2查询地域Endpoint信息-对象存储-阿里云
...
## 相关文档
- 关于查询地域对应Endpoint信息的API接口描述，请参见[DescribeRegions](https://help.aliyun.com/zh/oss/developer-reference/describeregions)。
- 关于查询地域对应Endpoint信息的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/DescribeRegions.php)。

[上一篇：请求者付费模式（PHP SDK V2）](/zh/oss/developer-reference/php-v2-pay-by-requester)[下一篇：对象/文件（PHP SDK V2）](/zh/oss/developer-reference/object-file-with-oss-sdk-for-php-v2/)该文章对您有帮助吗？反馈
