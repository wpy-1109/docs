...
Source: https://help.aliyun.com/zh/oss/developer-reference/determine-whether-the-file-exists-using-oss-sdk-for-php-v2

---

- PHP SDK V2判断文件是否存在-对象存储-阿里云
...
本文介绍如何使用OSS PHP SDK V2判断文件是否存在。
...
// 打印检查结果
printf(
    'object is exist:' . var_export($exist, true) . PHP_EOL // 输出对象是否存在的布尔值
);

```

## 相关文档
- 关于判断文件是否存在的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/alibabacloud-oss-php-sdk-v2/blob/master/sample/IsObjectExist.php)。
- 关于判断文件是否存在的API接口，请参见[IsObjectExist](https://pkg.go.dev/github.com/aliyun/alibabacloud-oss-go-sdk-v2/oss#Client.IsObjectExist)。

[上一篇：管理文件（PHP SDK V2）](/zh/oss/developer-reference/manage-files-using-oss-sdk-for-php-v2/)[下一篇：列举文件（PHP SDK V2）](/zh/oss/developer-reference/list-objects-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
