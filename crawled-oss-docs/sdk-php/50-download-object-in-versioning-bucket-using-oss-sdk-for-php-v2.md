# 使用PHP SDK V2下载指定版本的文件

Source: https://help.aliyun.com/zh/oss/developer-reference/download-object-in-versioning-bucket-using-oss-sdk-for-php-v2

---

- 使用PHP SDK V2下载指定版本的文件-对象存储-阿里云
...
本文介绍如何使用PHP SDK V2在开启版本控制的存储空间（Bucket）中下载文件（Object）。
...
- 要下载文件，您必须有`oss:GetObject`权限。具体操作，请参见[为RAM用户授予自定义的权限策略](https://help.aliyun.com/zh/oss/user-guide/common-examples-of-ram-policies#section-ucu-jv0-zip)。
说明 
...
[上一篇：上传文件（PHP SDK V2）](/zh/oss/developer-reference/upload-object-in-versioning-bucket-using-oss-sdk-for-php-v2)[下一篇：拷贝文件（PHP SDK V2）](/zh/oss/developer-reference/copy-an-versioning-object-using-oss-sdk-for-php-v2)该文章对您有帮助吗？反馈
