# I apologize, but the provided text does not contain the section "## 2. 最终结果" or the line "最终搜索标题：". Therefore, I cannot extract the requested information.

Source: https://help.aliyun.com/zh/oss/developer-reference/copy-objects-12
...
## 注意事项
- 使用本文示例前您需要先通过自定义域名、STS等方式新建OSSClient，具体请参见[初始化（iOS SDK）](https://help.aliyun.com/zh/oss/developer-reference/initialization-8#concept-32057-zh)。
...
[上一篇：重命名文件（iOS SDK）](/zh/oss/developer-reference/rename-objects-1)[下一篇：删除文件（iOS SDK）](/zh/oss/developer-reference/delete-objects-14)该文章对您有帮助吗？反馈
