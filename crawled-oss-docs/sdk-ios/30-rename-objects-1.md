# 使用iOS SDK通过拷贝后删除的方式重命名文件

Source: https://help.aliyun.com/zh/oss/developer-reference/rename-objects-1

---

- 使用iOS SDK通过拷贝后删除的方式重命名文件-对象存储-阿里云
...
[上一篇：列举文件（iOS SDK）](/zh/oss/developer-reference/list-objects-13)[下一篇：拷贝文件（iOS SDK）](/zh/oss/developer-reference/copy-objects-12)该文章对您有帮助吗？反馈
