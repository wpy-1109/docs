...
Source: https://help.aliyun.com/zh/oss/developer-reference/range-download-7

---

- 使用iOS SDK实现文件范围下载-对象存储-阿里云
...
[上一篇：流式下载（iOS SDK）](/zh/oss/developer-reference/streaming-download-6)[下一篇：断点续传下载（iOS SDK）](/zh/oss/developer-reference/resumable-download)该文章对您有帮助吗？反馈
