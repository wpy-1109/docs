...
Source: https://help.aliyun.com/zh/oss/developer-reference/simple-download

---

- 使用iOS SDK下载Object文件-对象存储-阿里云
...
// request.downloadToFileURL = [NSURL fileURLWithPath:@""]; // 如果需要直接下载到文件，需要指明目标文件地址。
...
## 相关文档
- 关于简单下载的API接口说明，请参见[GetObject](https://help.aliyun.com/zh/oss/developer-reference/getobject#reference-ccf-rgd-5db)。
- 关于初始化OSSClient，请参见[如何初始化OSSClient实例](https://help.aliyun.com/zh/oss/developer-reference/initialization-8#concept-32057-zh)。

[上一篇：下载文件（iOS SDK）](/zh/oss/developer-reference/download-objects-15/)[下一篇：流式下载（iOS SDK）](/zh/oss/developer-reference/streaming-download-6)该文章对您有帮助吗？反馈
