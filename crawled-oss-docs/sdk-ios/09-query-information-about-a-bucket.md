# 使用iOS SDK获取存储空间的基本信息

Source: https://help.aliyun.com/zh/oss/developer-reference/query-information-about-a-bucket

---

- 使用iOS SDK获取存储空间的基本信息-对象存储-阿里云
...
## 相关文档
- 关于获取存储空间信息的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-ios-sdk/blob/master/AliyunOSSiOSTests/OSSBucketTests.m?spm=a2c4g.11186623.0.0.5a3c7873YugaHF&file=OSSBucketTests.m)。
...
[上一篇：获取存储空间读写权限（iOS SDK）](/zh/oss/developer-reference/query-the-acl-of-a-bucket)[下一篇：删除存储空间（iOS SDK）](/zh/oss/developer-reference/delete-a-bucket-2)该文章对您有帮助吗？反馈
