# OSS iOS SDK设置与获取文件访问权限

Source: https://help.aliyun.com/zh/oss/developer-reference/manage-the-acl-of-an-object

---

- OSS iOS SDK设置与获取文件访问权限-对象存储-阿里云
...
[上一篇：解冻文件（iOS SDK）](/zh/oss/developer-reference/restore-objects-4)[下一篇：对象标签（iOS SDK）](/zh/oss/developer-reference/object-tagging-1)该文章对您有帮助吗？反馈
