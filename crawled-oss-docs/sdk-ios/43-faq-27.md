# 调用iOS SDK接口报错4099的解决方法

Source: https://help.aliyun.com/zh/oss/developer-reference/faq-27

---

- 调用iOS SDK接口报错4099的解决方法-对象存储-阿里云
...
本文介绍使用OSS iOS SDK的常见问题及解决方法。

## 调用iOS SDK相关接口打印报错4099，怎么办？
...
通过以下两种方式关闭接收消息日志动态并在系统级别设置“com.apple.CoreTelephony”子系统级别。
- 方式一
```
...
[上一篇：异常响应（iOS SDK）](/zh/oss/developer-reference/handle-exceptions)[下一篇：OSS C SDK](/zh/oss/developer-reference/preface-2/)该文章对您有帮助吗？反馈
