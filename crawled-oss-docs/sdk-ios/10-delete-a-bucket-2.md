# 使用iOS SDK删除存储空间Bucket

Source: https://help.aliyun.com/zh/oss/developer-reference/delete-a-bucket-2

---

- 使用iOS SDK删除存储空间Bucket-对象存储-阿里云
...
- 已删除Bucket的所有Livechannel。具体操作，请参见[DeleteLiveChannel](https://help.aliyun.com/zh/oss/developer-reference/deletelivechannel#reference-d4g-k12-xdb)。
...
说明 
所删除的存储空间的所属地域取决于初始化配置的endpoint地域信息。
...
## 相关文档
- 关于删除Bucket的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-ios-sdk/blob/master/AliyunOSSiOSTests/OSSBucketTests.m?spm=a2c4g.11186623.0.0.5a3c7873YugaHF&file=OSSBucketTests.m)。
...
[上一篇：获取存储空间的信息（iOS SDK）](/zh/oss/developer-reference/query-information-about-a-bucket)[下一篇：对象/文件（iOS SDK）](/zh/oss/developer-reference/objects-9/)该文章对您有帮助吗？反馈
