# 使用iOS SDK解冻归档存储类型的文件

Source: https://help.aliyun.com/zh/oss/developer-reference/restore-objects-4

---

- 使用iOS SDK解冻归档存储类型的文件-对象存储-阿里云
...
## 相关文档
- 关于解冻归档Object的API接口说明，请参见[RestoreObject](https://help.aliyun.com/zh/oss/developer-reference/restoreobject#reference-mfr-5bx-wdb)。
- 关于初始化OSSClient，请参见[如何初始化OSSClient实例](https://help.aliyun.com/zh/oss/developer-reference/initialization-8#concept-32057-zh)。

[上一篇：管理软链接（iOS SDK）](/zh/oss/developer-reference/manage-symbolic-links)[下一篇：管理文件访问权限（iOS SDK）](/zh/oss/developer-reference/manage-the-acl-of-an-object)该文章对您有帮助吗？反馈
