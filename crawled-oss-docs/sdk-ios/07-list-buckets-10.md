# 使用iOS SDK按条件获取存储空间Bucket列表

Source: https://help.aliyun.com/zh/oss/developer-reference/list-buckets-10

---

- 使用iOS SDK按条件获取存储空间Bucket列表-对象存储-阿里云
...
## 注意事项
- 使用本文示例前您需要先通过自定义域名、STS等方式新建OSSClient，具体请参见[初始化](https://help.aliyun.com/zh/oss/developer-reference/initialization-8#concept-32057-zh)。说明 所列举的存储空间的所属地域取决于初始化配置的endpoint地域信息。
...
[上一篇：创建存储空间（iOS SDK）](/zh/oss/developer-reference/create-buckets-1)[下一篇：获取存储空间读写权限（iOS SDK）](/zh/oss/developer-reference/query-the-acl-of-a-bucket)该文章对您有帮助吗？反馈
