...
Source: https://help.aliyun.com/zh/oss/developer-reference/progress-bar-3

---

- 使用iOS SDK获取文件上传进度-对象存储-阿里云
...
## 相关文档
- 关于上传文件时进度条的完整示例代码，请参见[GitHub示例](https://github.com/aliyun/aliyun-oss-ios-sdk/blob/master/AliyunOSSiOSTests/OSSObjectTests.m)。
- 关于初始化OSSClient，请参见[如何初始化OSSClient实例](https://help.aliyun.com/zh/oss/developer-reference/initialization-8#concept-32057-zh)。

[上一篇：上传回调（iOS SDK）](/zh/oss/developer-reference/upload-callbacks-7)[下一篇：下载文件（iOS SDK）](/zh/oss/developer-reference/download-objects-15/)该文章对您有帮助吗？反馈
